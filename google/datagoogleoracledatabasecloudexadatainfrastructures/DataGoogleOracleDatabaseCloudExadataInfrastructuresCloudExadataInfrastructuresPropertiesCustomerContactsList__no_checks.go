...
func (d *jsiiProxy_DataGoogleOracleDatabaseCloudExadataInfrastructuresCloudExadataInfrastructuresPropertiesCustomerContactsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
