...
func (j *jsiiProxy_BigtableInstance) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_BigtableInstance) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_BigtableInstance) Timeouts() BigtableInstanceTimeoutsOutputReference {
	var returns BigtableInstanceTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.36.0/docs/resources/bigtable_instance google_bigtable_instance} Resource.
...
func BigtableInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBigtableInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BigtableInstance) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BigtableInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BigtableInstance) MoveFromId(id *string) {
...
func (b *jsiiProxy_BigtableInstance) MoveToId(id *string) {
...
func (b *jsiiProxy_BigtableInstance) PutTimeouts(value *BigtableInstanceTimeouts) {
...
func (b *jsiiProxy_BigtableInstance) ResetForceDestroy() {
	_jsii_.InvokeVoid(
		b,
		"resetForceDestroy",
		nil, // no parameters
...
func (b *jsiiProxy_BigtableInstance) ResetTimeouts() {
	_jsii_.InvokeVoid(
		b,
		"resetTimeouts",
		nil, // no parameters
