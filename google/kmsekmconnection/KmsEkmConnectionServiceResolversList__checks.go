...
func (j *jsiiProxy_KmsEkmConnectionServiceResolversList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*KmsEkmConnectionServiceResolvers:
		val_ := val.([]*KmsEkmConnectionServiceResolvers)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_KmsEkmConnectionServiceResolversList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_KmsEkmConnectionServiceResolversList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
