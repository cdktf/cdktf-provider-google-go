...
func (l *jsiiProxy_LoggingMetricBucketOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LoggingMetricBucketOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
