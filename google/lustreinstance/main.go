...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gkeSupportEnabled", GoGetter: "GkeSupportEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "gkeSupportEnabledInput", GoGetter: "GkeSupportEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGkeSupportEnabled", GoMethod: "ResetGkeSupportEnabled"},
