...
type CloudRunServiceTraffic struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/cloud_run_service#percent CloudRunService#percent}
