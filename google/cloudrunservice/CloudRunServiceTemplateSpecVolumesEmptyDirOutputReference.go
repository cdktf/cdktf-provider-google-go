...
func (c *jsiiProxy_CloudRunServiceTemplateSpecVolumesEmptyDirOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunServiceTemplateSpecVolumesEmptyDirOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
