...
func (c *jsiiProxy_CloudRunServiceStatusList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_CloudRunServiceStatusList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
