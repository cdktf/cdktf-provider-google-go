...
func (c *jsiiProxy_CloudRunServiceTemplateSpecContainersEnvFromConfigMapRefOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunServiceTemplateSpecContainersEnvFromConfigMapRefOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
