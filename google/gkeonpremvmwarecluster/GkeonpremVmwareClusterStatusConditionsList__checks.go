...
func (g *jsiiProxy_GkeonpremVmwareClusterStatusConditionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GkeonpremVmwareClusterStatusConditionsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GkeonpremVmwareClusterStatusConditionsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GkeonpremVmwareClusterStatusConditionsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
