...
func (g *jsiiProxy_GkeonpremVmwareClusterValidationCheckList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GkeonpremVmwareClusterValidationCheckList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GkeonpremVmwareClusterValidationCheckList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GkeonpremVmwareClusterValidationCheckList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
