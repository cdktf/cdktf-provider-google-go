...
func (c *jsiiProxy_CloudTasksQueueHttpTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudTasksQueueHttpTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
