...
func (c *jsiiProxy_CloudTasksQueueRateLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudTasksQueueRateLimitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
