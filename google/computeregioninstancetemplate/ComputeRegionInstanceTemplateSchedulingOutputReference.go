...
func (c *jsiiProxy_ComputeRegionInstanceTemplateSchedulingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionInstanceTemplateSchedulingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
