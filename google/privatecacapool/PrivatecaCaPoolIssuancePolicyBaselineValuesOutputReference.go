...
func (p *jsiiProxy_PrivatecaCaPoolIssuancePolicyBaselineValuesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivatecaCaPoolIssuancePolicyBaselineValuesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
