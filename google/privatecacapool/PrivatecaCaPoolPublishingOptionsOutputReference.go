...
func (p *jsiiProxy_PrivatecaCaPoolPublishingOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivatecaCaPoolPublishingOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
