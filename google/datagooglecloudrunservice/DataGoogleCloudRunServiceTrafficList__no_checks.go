...
func (d *jsiiProxy_DataGoogleCloudRunServiceTrafficList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGoogleCloudRunServiceTrafficList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
