...
func (j *jsiiProxy_CertificateManagerCertificateMapGclbTargetsIpConfigsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCertificateManagerCertificateMapGclbTargetsIpConfigsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CertificateManagerCertificateMapGclbTargetsIpConfigsList {
	_init_.Initialize()
...
func NewCertificateManagerCertificateMapGclbTargetsIpConfigsList_Override(c CertificateManagerCertificateMapGclbTargetsIpConfigsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CertificateManagerCertificateMapGclbTargetsIpConfigsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CertificateManagerCertificateMapGclbTargetsIpConfigsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CertificateManagerCertificateMapGclbTargetsIpConfigsList) Resolve(_context cdktf.IResolveContext) interface{} {
