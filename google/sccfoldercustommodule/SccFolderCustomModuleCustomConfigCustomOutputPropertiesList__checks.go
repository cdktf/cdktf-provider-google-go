...
func (s *jsiiProxy_SccFolderCustomModuleCustomConfigCustomOutputPropertiesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SccFolderCustomModuleCustomConfigCustomOutputPropertiesList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*SccFolderCustomModuleCustomConfigCustomOutputProperties:
		val_ := val.([]*SccFolderCustomModuleCustomConfigCustomOutputProperties)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_SccFolderCustomModuleCustomConfigCustomOutputPropertiesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_SccFolderCustomModuleCustomConfigCustomOutputPropertiesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
