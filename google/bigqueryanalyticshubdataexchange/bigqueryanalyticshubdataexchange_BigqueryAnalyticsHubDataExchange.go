...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v4/bigqueryanalyticshubdataexchange/internal"
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google/r/bigquery_analytics_hub_data_exchange google_bigquery_analytics_hub_data_exchange} Resource.
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchange)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
