...
func (j *jsiiProxy_ComputeResizeRequestStatusErrorList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputeResizeRequestStatusErrorList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ComputeResizeRequestStatusErrorList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ComputeResizeRequestStatusErrorList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ComputeResizeRequestStatusErrorList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_ComputeResizeRequestStatusErrorList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ComputeResizeRequestStatusErrorList) Get(index *float64) ComputeResizeRequestStatusErrorOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ComputeResizeRequestStatusErrorOutputReference
...
func (c *jsiiProxy_ComputeResizeRequestStatusErrorList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ComputeResizeRequestStatusErrorList) ToString() *string {
	var returns *string
