...
func (g *jsiiProxy_GkeonpremVmwareAdminClusterLoadBalancerManualLbConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeonpremVmwareAdminClusterLoadBalancerManualLbConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
