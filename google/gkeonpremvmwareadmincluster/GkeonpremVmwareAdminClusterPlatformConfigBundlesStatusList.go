...
func (j *jsiiProxy_GkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList {
	_init_.Initialize()
...
func NewGkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList_Override(g GkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GkeonpremVmwareAdminClusterPlatformConfigBundlesStatusList) Resolve(_context cdktf.IResolveContext) interface{} {
