...
func (c *jsiiProxy_ContainerAzureClusterControlPlaneOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAzureClusterControlPlaneOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
