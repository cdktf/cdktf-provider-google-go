...
func (c *jsiiProxy_ContainerAzureClusterAuthorizationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAzureClusterAuthorizationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
