...
func (d *jsiiProxy_DnsResponsePolicyNetworksList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DnsResponsePolicyNetworksList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
