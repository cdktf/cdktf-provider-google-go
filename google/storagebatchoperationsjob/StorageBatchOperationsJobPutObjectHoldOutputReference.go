...
func (s *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBatchOperationsJobPutObjectHoldOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
