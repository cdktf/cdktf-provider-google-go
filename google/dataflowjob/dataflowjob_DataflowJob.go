...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/dataflowjob/internal"
...
func (j *jsiiProxy_DataflowJob) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataflowJob)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
