...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "imageEncryptionKeySha256", GoGetter: "ImageEncryptionKeySha256"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceDiskEncryptionKeySha256", GoGetter: "SourceDiskEncryptionKeySha256"},
