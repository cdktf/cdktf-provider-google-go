...
func (j *jsiiProxy_DataGoogleArtifactRegistryDockerImagesDockerImagesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleArtifactRegistryDockerImagesDockerImagesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleArtifactRegistryDockerImagesDockerImagesList {
	_init_.Initialize()
...
func NewDataGoogleArtifactRegistryDockerImagesDockerImagesList_Override(d DataGoogleArtifactRegistryDockerImagesDockerImagesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleArtifactRegistryDockerImagesDockerImagesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryDockerImagesDockerImagesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryDockerImagesDockerImagesList) Resolve(_context cdktf.IResolveContext) interface{} {
