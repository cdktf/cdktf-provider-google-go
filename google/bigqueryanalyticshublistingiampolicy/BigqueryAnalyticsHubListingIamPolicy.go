...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/bigqueryanalyticshublistingiampolicy/internal"
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.38.0/docs/resources/bigquery_analytics_hub_listing_iam_policy google_bigquery_analytics_hub_listing_iam_policy} Resource.
...
func BigqueryAnalyticsHubListingIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
