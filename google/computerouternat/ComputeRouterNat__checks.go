...
func (c *jsiiProxy_ComputeRouterNat) validatePutNat64SubnetworkParameters(value interface{}) error {
	...
	case *[]*ComputeRouterNatNat64Subnetwork:
		value := value.(*[]*ComputeRouterNatNat64Subnetwork)
	...
	case []*ComputeRouterNatNat64Subnetwork:
		value_ := value.([]*ComputeRouterNatNat64Subnetwork)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ComputeRouterNatNat64Subnetwork; received %#v (a %T)", value, value)
		}
	}
