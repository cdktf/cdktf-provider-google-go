...
func (d *jsiiProxy_DialogflowIntentFollowupIntentInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowIntentFollowupIntentInfoList) Resolve(context cdktf.IResolveContext) interface{} {
