...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "profileAssessmentConfigs", GoGetter: "ProfileAssessmentConfigs"},
			_jsii_.MemberProperty{JsiiProperty: "profileAssessmentConfigsInput", GoGetter: "ProfileAssessmentConfigsInput"},
