...
func (s *jsiiProxy_StorageBucketObjectCustomerEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketObjectCustomerEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
