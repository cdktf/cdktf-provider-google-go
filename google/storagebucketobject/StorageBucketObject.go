...
func (j *jsiiProxy_StorageBucketObject) SourceMd5Hash() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceMd5Hash",
...
func (j *jsiiProxy_StorageBucketObject) SourceMd5HashInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceMd5HashInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/storage_bucket_object google_storage_bucket_object} Resource.
...
func (s *jsiiProxy_StorageBucketObject) ResetSourceMd5Hash() {
	_jsii_.InvokeVoid(
		s,
		"resetSourceMd5Hash",
		nil, // no parameters
