...
func (c *jsiiProxy_CertificateManagerTrustConfigTrustStoresTrustAnchorsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_CertificateManagerTrustConfigTrustStoresTrustAnchorsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
