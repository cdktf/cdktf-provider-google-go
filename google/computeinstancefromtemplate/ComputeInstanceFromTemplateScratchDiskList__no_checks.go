...
func (c *jsiiProxy_ComputeInstanceFromTemplateScratchDiskList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_ComputeInstanceFromTemplateScratchDiskList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
