...
func (c *jsiiProxy_ComputeInstanceFromTemplateShieldedInstanceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceFromTemplateShieldedInstanceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
