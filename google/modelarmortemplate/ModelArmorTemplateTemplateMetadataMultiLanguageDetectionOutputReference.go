...
func (m *jsiiProxy_ModelArmorTemplateTemplateMetadataMultiLanguageDetectionOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ModelArmorTemplateTemplateMetadataMultiLanguageDetectionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
