...
type LoggingLinkedDatasetConfig struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.79.0/docs/resources/logging_linked_dataset#id LoggingLinkedDataset#id}.
	//
