...
type DataLossPreventionDiscoveryConfigTargetsCloudStorageTargetFilterCloudStorageResourceReference struct {
	// The bucket to scan.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/resources/data_loss_prevention_discovery_config#bucket_name DataLossPreventionDiscoveryConfig#bucket_name}
