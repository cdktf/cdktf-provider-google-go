...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigActionsPubSubNotificationOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionDiscoveryConfigActionsPubSubNotificationOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
