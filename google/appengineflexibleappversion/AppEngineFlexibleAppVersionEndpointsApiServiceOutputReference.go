...
func (a *jsiiProxy_AppEngineFlexibleAppVersionEndpointsApiServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineFlexibleAppVersionEndpointsApiServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
