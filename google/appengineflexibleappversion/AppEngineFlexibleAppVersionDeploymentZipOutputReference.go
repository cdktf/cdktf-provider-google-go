...
func (a *jsiiProxy_AppEngineFlexibleAppVersionDeploymentZipOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineFlexibleAppVersionDeploymentZipOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
