...
func (j *jsiiProxy_SecureSourceManagerInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_SecureSourceManagerInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/secure_source_manager_instance google_secure_source_manager_instance} Resource.
...
func (s *jsiiProxy_SecureSourceManagerInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionPolicy",
		nil, // no parameters
