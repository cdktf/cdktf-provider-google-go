...
func (a *jsiiProxy_ApigeeSharedflowMetaDataList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_ApigeeSharedflowMetaDataList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ApigeeSharedflowMetaDataList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ApigeeSharedflowMetaDataList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
