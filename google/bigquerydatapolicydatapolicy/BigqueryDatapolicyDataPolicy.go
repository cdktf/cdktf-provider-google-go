...
func (j *jsiiProxy_BigqueryDatapolicyDataPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google/r/bigquery_datapolicy_data_policy google_bigquery_datapolicy_data_policy} Resource.
...
func (j *jsiiProxy_BigqueryDatapolicyDataPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
