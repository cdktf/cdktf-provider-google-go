...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.19.0/docs/resources/bigquery_analytics_hub_listing_iam_binding google_bigquery_analytics_hub_listing_iam_binding} Resource.
...
func BigqueryAnalyticsHubListingIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBigqueryAnalyticsHubListingIamBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamBinding) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamBinding) MoveFromId(id *string) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingIamBinding) MoveToId(id *string) {
