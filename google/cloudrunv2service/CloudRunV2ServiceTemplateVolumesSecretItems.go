...
type CloudRunV2ServiceTemplateVolumesSecretItems struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.0/docs/resources/cloud_run_v2_service#mode CloudRunV2Service#mode}
