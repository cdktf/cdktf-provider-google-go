...
func (c *jsiiProxy_CloudRunV2ServiceTemplateVolumesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunV2ServiceTemplateVolumesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
