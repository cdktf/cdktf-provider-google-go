...
func (c *jsiiProxy_CloudRunV2ServiceTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunV2ServiceTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
