...
func (g *jsiiProxy_GkeHubScopeStateList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GkeHubScopeStateList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
