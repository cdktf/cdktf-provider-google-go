...
func (a *jsiiProxy_AssuredWorkloadsWorkloadResourcesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (a *jsiiProxy_AssuredWorkloadsWorkloadResourcesList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourcesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_AssuredWorkloadsWorkloadResourcesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
