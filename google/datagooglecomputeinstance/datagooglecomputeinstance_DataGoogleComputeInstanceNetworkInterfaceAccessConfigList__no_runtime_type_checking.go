...
func (d *jsiiProxy_DataGoogleComputeInstanceNetworkInterfaceAccessConfigList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeInstanceNetworkInterfaceAccessConfigList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeInstanceNetworkInterfaceAccessConfigList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
