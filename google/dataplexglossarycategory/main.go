...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "categoryId", GoGetter: "CategoryId"},
			_jsii_.MemberProperty{JsiiProperty: "categoryIdInput", GoGetter: "CategoryIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCategoryId", GoMethod: "ResetCategoryId"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisplayName", GoMethod: "ResetDisplayName"},
			_jsii_.MemberMethod{JsiiMethod: "resetGlossaryId", GoMethod: "ResetGlossaryId"},
