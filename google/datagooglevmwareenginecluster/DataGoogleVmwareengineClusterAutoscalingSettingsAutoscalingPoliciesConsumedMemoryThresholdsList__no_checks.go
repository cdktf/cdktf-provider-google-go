...
func (d *jsiiProxy_DataGoogleVmwareengineClusterAutoscalingSettingsAutoscalingPoliciesConsumedMemoryThresholdsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
