...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/datagoogleiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/data-sources/iam_policy google_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/data-sources/iam_policy google_iam_policy} Data Source.
...
func DataGoogleIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataGoogleIamPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
