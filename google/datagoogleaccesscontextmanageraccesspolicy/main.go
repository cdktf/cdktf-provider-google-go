...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleAccessContextManagerAccessPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.dataGoogleAccessContextManagerAccessPolicy.DataGoogleAccessContextManagerAccessPolicyConfig",
		reflect.TypeOf((*DataGoogleAccessContextManagerAccessPolicyConfig)(nil)).Elem(),
	)
}
