...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "celMatch", GoGetter: "CelMatch"},
			_jsii_.MemberProperty{JsiiProperty: "celMatchInput", GoGetter: "CelMatchInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "enrollmentId", GoGetter: "EnrollmentId"},
			_jsii_.MemberProperty{JsiiProperty: "enrollmentIdInput", GoGetter: "EnrollmentIdInput"},
