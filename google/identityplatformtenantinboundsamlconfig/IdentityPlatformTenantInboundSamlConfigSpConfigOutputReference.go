...
func (i *jsiiProxy_IdentityPlatformTenantInboundSamlConfigSpConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformTenantInboundSamlConfigSpConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
