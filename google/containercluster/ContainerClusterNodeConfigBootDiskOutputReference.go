...
func (c *jsiiProxy_ContainerClusterNodeConfigBootDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterNodeConfigBootDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
