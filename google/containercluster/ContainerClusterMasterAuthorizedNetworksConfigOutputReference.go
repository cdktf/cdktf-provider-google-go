...
func (c *jsiiProxy_ContainerClusterMasterAuthorizedNetworksConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterMasterAuthorizedNetworksConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
