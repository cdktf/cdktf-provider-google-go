...
func (c *jsiiProxy_ContainerClusterNodeConfigKubeletConfigEvictionSoftOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterNodeConfigKubeletConfigEvictionSoftOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
