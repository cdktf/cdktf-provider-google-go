...
func (c *jsiiProxy_ContainerClusterEnableK8SBetaApisOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterEnableK8SBetaApisOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
