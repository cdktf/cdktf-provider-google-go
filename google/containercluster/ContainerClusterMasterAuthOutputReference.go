...
type ContainerClusterMasterAuthOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *ContainerClusterMasterAuth
	SetInternalValue(val *ContainerClusterMasterAuth)
	// Experimental.
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) ClientCertificateConfig() ContainerClusterMasterAuthClientCertificateConfigOutputReference {
	var returns ContainerClusterMasterAuthClientCertificateConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) ClientCertificateConfigInput() *ContainerClusterMasterAuthClientCertificateConfig {
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) ClientKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientKey",
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) ClusterCaCertificate() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) InternalValue() *ContainerClusterMasterAuth {
...
func (j *jsiiProxy_ContainerClusterMasterAuthOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) PutClientCertificateConfig(value *ContainerClusterMasterAuthClientCertificateConfig) {
	if err := c.validatePutClientCertificateConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ContainerClusterMasterAuthOutputReference) ToString() *string {
	var returns *string
