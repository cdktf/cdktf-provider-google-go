...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) AutoProvisioningLocations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) AutoProvisioningLocationsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) ResetAutoProvisioningLocations() {
	_jsii_.InvokeVoid(
		c,
		"resetAutoProvisioningLocations",
		nil, // no parameters
...
func (c *jsiiProxy_ContainerClusterClusterAutoscalingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
