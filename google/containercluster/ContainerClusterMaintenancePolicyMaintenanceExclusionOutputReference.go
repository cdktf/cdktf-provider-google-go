...
func (c *jsiiProxy_ContainerClusterMaintenancePolicyMaintenanceExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterMaintenancePolicyMaintenanceExclusionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
