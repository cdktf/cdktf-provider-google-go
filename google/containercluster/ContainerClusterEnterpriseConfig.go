...
type ContainerClusterEnterpriseConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.18.1/docs/resources/container_cluster#desired_tier ContainerCluster#desired_tier}
