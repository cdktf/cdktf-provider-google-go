...
func (c *jsiiProxy_ContainerClusterNotificationConfigPubsubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerClusterNotificationConfigPubsubOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
