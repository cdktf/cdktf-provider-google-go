...
func (d *jsiiProxy_DialogflowCxEntityTypeExcludedPhrasesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxEntityTypeExcludedPhrasesList) Resolve(context cdktf.IResolveContext) interface{} {
