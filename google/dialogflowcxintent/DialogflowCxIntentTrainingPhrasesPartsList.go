...
func (d *jsiiProxy_DialogflowCxIntentTrainingPhrasesPartsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxIntentTrainingPhrasesPartsList) Resolve(context cdktf.IResolveContext) interface{} {
