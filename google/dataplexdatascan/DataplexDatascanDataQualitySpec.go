...
type DataplexDatascanDataQualitySpec struct {
	...
	// rules block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/dataplex_datascan#rules DataplexDatascan#rules}
