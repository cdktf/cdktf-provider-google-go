...
func (d *jsiiProxy_DataplexDatascanDataQualitySpecRulesRangeExpectationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexDatascanDataQualitySpecRulesRangeExpectationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
