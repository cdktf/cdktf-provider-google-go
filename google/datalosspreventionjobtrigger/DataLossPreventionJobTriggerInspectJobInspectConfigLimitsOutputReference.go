...
func (d *jsiiProxy_DataLossPreventionJobTriggerInspectJobInspectConfigLimitsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLossPreventionJobTriggerInspectJobInspectConfigLimitsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
