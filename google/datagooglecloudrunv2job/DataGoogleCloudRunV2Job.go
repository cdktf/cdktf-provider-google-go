...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/data-sources/cloud_run_v2_job google_cloud_run_v2_job}.
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) BinaryAuthorization() DataGoogleCloudRunV2JobBinaryAuthorizationList {
	var returns DataGoogleCloudRunV2JobBinaryAuthorizationList
	_jsii_.Get(
		j,
		"binaryAuthorization",
		&returns,
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Client() *string {
	var returns *string
	_jsii_.Get(
		j,
		"client",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) ClientVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"clientVersion",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Conditions() DataGoogleCloudRunV2JobConditionsList {
	var returns DataGoogleCloudRunV2JobConditionsList
	_jsii_.Get(
		j,
		"conditions",
		&returns,
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Creator() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creator",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) DeleteTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deleteTime",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) ExecutionCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"executionCount",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) ExpireTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expireTime",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Generation() *string {
	var returns *string
	_jsii_.Get(
		j,
		"generation",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) LastModifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lastModifier",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) LatestCreatedExecution() DataGoogleCloudRunV2JobLatestCreatedExecutionList {
	var returns DataGoogleCloudRunV2JobLatestCreatedExecutionList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) LaunchStage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"launchStage",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) ObservedGeneration() *string {
	var returns *string
	_jsii_.Get(
		j,
		"observedGeneration",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Template() DataGoogleCloudRunV2JobTemplateList {
	var returns DataGoogleCloudRunV2JobTemplateList
	_jsii_.Get(
		j,
		"template",
		&returns,
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) TerminalCondition() DataGoogleCloudRunV2JobTerminalConditionList {
	var returns DataGoogleCloudRunV2JobTerminalConditionList
	_jsii_.Get(
		j,
		"terminalCondition",
		&returns,
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Uid() *string {
	var returns *string
	_jsii_.Get(
		j,
		"uid",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.43.0/docs/data-sources/cloud_run_v2_job google_cloud_run_v2_job} Data Source.
func NewDataGoogleCloudRunV2Job(scope constructs.Construct, id *string, config *DataGoogleCloudRunV2JobConfig) DataGoogleCloudRunV2Job {
	...
	if err := validateNewDataGoogleCloudRunV2JobParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleCloudRunV2Job_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleCloudRunV2Job.DataGoogleCloudRunV2Job",
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleCloudRunV2Job) ToString() *string {
	var returns *string
