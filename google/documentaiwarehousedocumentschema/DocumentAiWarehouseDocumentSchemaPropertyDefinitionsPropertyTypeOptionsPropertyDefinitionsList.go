...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchemaPropertyDefinitionsPropertyTypeOptionsPropertyDefinitionsList) Resolve(context cdktf.IResolveContext) interface{} {
