...
type jsiiProxy_DocumentAiWarehouseDocumentSchema struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Node() constructs.Node {
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) ProjectNumber() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNumber",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) ProjectNumberInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectNumberInput",
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) PropertyDefinitions() DocumentAiWarehouseDocumentSchemaPropertyDefinitionsList {
	var returns DocumentAiWarehouseDocumentSchemaPropertyDefinitionsList
	_jsii_.Get(
		j,
		"propertyDefinitions",
		&returns,
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DocumentAiWarehouseDocumentSchema) Timeouts() DocumentAiWarehouseDocumentSchemaTimeoutsOutputReference {
	var returns DocumentAiWarehouseDocumentSchemaTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewDocumentAiWarehouseDocumentSchema(scope constructs.Construct, id *string, config *DocumentAiWarehouseDocumentSchemaConfig) DocumentAiWarehouseDocumentSchema {
	...
	if err := validateNewDocumentAiWarehouseDocumentSchemaParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DocumentAiWarehouseDocumentSchema_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDocumentAiWarehouseDocumentSchema_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DocumentAiWarehouseDocumentSchema_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.documentAiWarehouseDocumentSchema.DocumentAiWarehouseDocumentSchema",
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) PutTimeouts(value *DocumentAiWarehouseDocumentSchemaTimeouts) {
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) ResetDocumentIsFolder() {
	_jsii_.InvokeVoid(
		d,
		"resetDocumentIsFolder",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
...
func (d *jsiiProxy_DocumentAiWarehouseDocumentSchema) ToString() *string {
	var returns *string
