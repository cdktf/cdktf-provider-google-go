...
func (f *jsiiProxy_FirebaseAppHostingDomainCustomDomainStatusRequiredDnsUpdatesDesiredRecordsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
