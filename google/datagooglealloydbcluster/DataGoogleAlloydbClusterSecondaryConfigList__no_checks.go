...
func (d *jsiiProxy_DataGoogleAlloydbClusterSecondaryConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleAlloydbClusterSecondaryConfigList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleAlloydbClusterSecondaryConfigList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleAlloydbClusterSecondaryConfigList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
