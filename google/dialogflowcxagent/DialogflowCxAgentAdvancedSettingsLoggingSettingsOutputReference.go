...
func (d *jsiiProxy_DialogflowCxAgentAdvancedSettingsLoggingSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxAgentAdvancedSettingsLoggingSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
