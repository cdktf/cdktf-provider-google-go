...
func (d *jsiiProxy_DialogflowCxAgentAdvancedSettingsSpeechSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxAgentAdvancedSettingsSpeechSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
