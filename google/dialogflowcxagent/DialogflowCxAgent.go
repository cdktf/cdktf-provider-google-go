...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/dialogflowcxagent/internal"
...
func (j *jsiiProxy_DialogflowCxAgent) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DialogflowCxAgent)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
