...
func (a *jsiiProxy_AccessContextManagerServicePerimetersServicePerimetersSpecIngressPoliciesIngressToOperationsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
