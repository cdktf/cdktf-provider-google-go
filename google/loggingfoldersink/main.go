...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "interceptChildren", GoGetter: "InterceptChildren"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInterceptChildren", GoMethod: "ResetInterceptChildren"},
