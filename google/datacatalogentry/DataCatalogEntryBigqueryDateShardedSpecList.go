...
func (d *jsiiProxy_DataCatalogEntryBigqueryDateShardedSpecList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataCatalogEntryBigqueryDateShardedSpecList) Resolve(context cdktf.IResolveContext) interface{} {
