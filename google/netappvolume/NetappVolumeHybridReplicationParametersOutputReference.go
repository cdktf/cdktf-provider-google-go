...
func (n *jsiiProxy_NetappVolumeHybridReplicationParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeHybridReplicationParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
