...
func (j *jsiiProxy_BigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList {
	_init_.Initialize()
...
func NewBigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList_Override(b BigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList) Resolve(_context cdktf.IResolveContext) interface{} {
