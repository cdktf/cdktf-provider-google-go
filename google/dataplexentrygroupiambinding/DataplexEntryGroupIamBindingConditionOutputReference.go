...
func (d *jsiiProxy_DataplexEntryGroupIamBindingConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexEntryGroupIamBindingConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
