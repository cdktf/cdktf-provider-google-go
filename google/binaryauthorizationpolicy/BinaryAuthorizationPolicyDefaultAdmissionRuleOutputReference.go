...
func (b *jsiiProxy_BinaryAuthorizationPolicyDefaultAdmissionRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BinaryAuthorizationPolicyDefaultAdmissionRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
