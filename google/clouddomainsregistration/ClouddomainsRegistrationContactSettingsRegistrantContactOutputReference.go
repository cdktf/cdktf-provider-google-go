...
func (c *jsiiProxy_ClouddomainsRegistrationContactSettingsRegistrantContactOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddomainsRegistrationContactSettingsRegistrantContactOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
