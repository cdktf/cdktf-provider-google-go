...
func (c *jsiiProxy_ClouddomainsRegistrationDnsSettingsGlueRecordsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddomainsRegistrationDnsSettingsGlueRecordsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
