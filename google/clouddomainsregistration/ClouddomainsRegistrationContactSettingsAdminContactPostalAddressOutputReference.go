...
func (c *jsiiProxy_ClouddomainsRegistrationContactSettingsAdminContactPostalAddressOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddomainsRegistrationContactSettingsAdminContactPostalAddressOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
