...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfigFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageControlFolderIntelligenceConfigFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
