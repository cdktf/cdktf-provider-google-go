...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/computesnapshot/internal"
...
type jsiiProxy_ComputeSnapshot struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_ComputeSnapshot) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ComputeSnapshot) CreationTimestamp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"creationTimestamp",
...
func (j *jsiiProxy_ComputeSnapshot) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ComputeSnapshot) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ComputeSnapshot) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ComputeSnapshot) DiskSizeGb() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"diskSizeGb",
...
func (j *jsiiProxy_ComputeSnapshot) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ComputeSnapshot) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputeSnapshot) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ComputeSnapshot) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ComputeSnapshot) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ComputeSnapshot) LabelFingerprint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"labelFingerprint",
...
func (j *jsiiProxy_ComputeSnapshot) Labels() *map[string]*string {
...
func (j *jsiiProxy_ComputeSnapshot) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_ComputeSnapshot) Licenses() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"licenses",
...
func (j *jsiiProxy_ComputeSnapshot) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeSnapshot) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ComputeSnapshot) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ComputeSnapshot) Node() constructs.Node {
...
func (j *jsiiProxy_ComputeSnapshot) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputeSnapshot) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ComputeSnapshot) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_ComputeSnapshot) SnapshotEncryptionKey() ComputeSnapshotSnapshotEncryptionKeyOutputReference {
	var returns ComputeSnapshotSnapshotEncryptionKeyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeSnapshot) SnapshotEncryptionKeyInput() *ComputeSnapshotSnapshotEncryptionKey {
...
func (j *jsiiProxy_ComputeSnapshot) SnapshotId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"snapshotId",
...
func (j *jsiiProxy_ComputeSnapshot) SourceDiskEncryptionKey() ComputeSnapshotSourceDiskEncryptionKeyOutputReference {
	var returns ComputeSnapshotSourceDiskEncryptionKeyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeSnapshot) SourceDiskEncryptionKeyInput() *ComputeSnapshotSourceDiskEncryptionKey {
...
func (j *jsiiProxy_ComputeSnapshot) SourceDiskInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"sourceDiskInput",
...
func (j *jsiiProxy_ComputeSnapshot) StorageBytes() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"storageBytes",
...
func (j *jsiiProxy_ComputeSnapshot) StorageLocations() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"storageLocations",
...
func (j *jsiiProxy_ComputeSnapshot) StorageLocationsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeSnapshot) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ComputeSnapshot) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputeSnapshot) Timeouts() ComputeSnapshotTimeoutsOutputReference {
	var returns ComputeSnapshotTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ComputeSnapshot) Zone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zone",
...
func (j *jsiiProxy_ComputeSnapshot) ZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"zoneInput",
...
func NewComputeSnapshot(scope constructs.Construct, id *string, config *ComputeSnapshotConfig) ComputeSnapshot {
	...
	if err := validateNewComputeSnapshotParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeSnapshot) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSnapshot) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ComputeSnapshot) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ComputeSnapshot) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ComputeSnapshot) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ComputeSnapshot) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ComputeSnapshot) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ComputeSnapshot) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ComputeSnapshot) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSnapshot) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ComputeSnapshot) PutSourceDiskEncryptionKey(value *ComputeSnapshotSourceDiskEncryptionKey) {
...
func (c *jsiiProxy_ComputeSnapshot) PutTimeouts(value *ComputeSnapshotTimeouts) {
...
func (c *jsiiProxy_ComputeSnapshot) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetLabels() {
	_jsii_.InvokeVoid(
		c,
		"resetLabels",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetSnapshotEncryptionKey() {
	_jsii_.InvokeVoid(
		c,
		"resetSnapshotEncryptionKey",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetStorageLocations() {
	_jsii_.InvokeVoid(
		c,
		"resetStorageLocations",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ResetZone() {
	_jsii_.InvokeVoid(
		c,
		"resetZone",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeSnapshot) ToString() *string {
	var returns *string
