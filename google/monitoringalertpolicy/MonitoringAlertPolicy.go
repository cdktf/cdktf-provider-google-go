...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.11.0/docs/resources/monitoring_alert_policy google_monitoring_alert_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.11.0/docs/resources/monitoring_alert_policy google_monitoring_alert_policy} Resource.
...
func (m *jsiiProxy_MonitoringAlertPolicy) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitoringAlertPolicy) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitoringAlertPolicy) MoveToId(id *string) {
