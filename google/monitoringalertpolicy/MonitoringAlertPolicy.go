...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v5/monitoringalertpolicy/internal"
...
func (j *jsiiProxy_MonitoringAlertPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MonitoringAlertPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
