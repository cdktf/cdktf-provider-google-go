...
func (m *jsiiProxy_MonitoringAlertPolicyConditionsConditionThresholdAggregationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringAlertPolicyConditionsConditionThresholdAggregationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
