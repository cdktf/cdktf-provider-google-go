...
func (m *jsiiProxy_MonitoringAlertPolicyAlertStrategyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringAlertPolicyAlertStrategyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
