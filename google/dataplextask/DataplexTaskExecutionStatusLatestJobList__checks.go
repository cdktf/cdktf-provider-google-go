...
func (d *jsiiProxy_DataplexTaskExecutionStatusLatestJobList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataplexTaskExecutionStatusLatestJobList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
