...
func (d *jsiiProxy_DataplexTaskSparkInfrastructureSpecVpcNetworkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexTaskSparkInfrastructureSpecVpcNetworkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
