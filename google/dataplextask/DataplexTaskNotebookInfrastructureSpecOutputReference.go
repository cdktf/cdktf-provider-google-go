...
func (d *jsiiProxy_DataplexTaskNotebookInfrastructureSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataplexTaskNotebookInfrastructureSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
