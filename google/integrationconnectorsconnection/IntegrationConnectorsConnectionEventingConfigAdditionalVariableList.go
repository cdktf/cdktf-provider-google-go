...
func (j *jsiiProxy_IntegrationConnectorsConnectionEventingConfigAdditionalVariableList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_IntegrationConnectorsConnectionEventingConfigAdditionalVariableList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (i *jsiiProxy_IntegrationConnectorsConnectionEventingConfigAdditionalVariableList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IntegrationConnectorsConnectionEventingConfigAdditionalVariableList) Resolve(_context cdktf.IResolveContext) interface{} {
