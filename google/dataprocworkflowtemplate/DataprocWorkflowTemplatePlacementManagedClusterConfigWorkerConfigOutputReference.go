...
func (d *jsiiProxy_DataprocWorkflowTemplatePlacementManagedClusterConfigWorkerConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocWorkflowTemplatePlacementManagedClusterConfigWorkerConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
