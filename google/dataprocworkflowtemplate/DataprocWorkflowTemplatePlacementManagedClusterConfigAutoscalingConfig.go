...
type DataprocWorkflowTemplatePlacementManagedClusterConfigAutoscalingConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/dataproc_workflow_template#policy DataprocWorkflowTemplate#policy}
