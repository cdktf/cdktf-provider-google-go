...
func (d *jsiiProxy_DataprocWorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfigList) Resolve(context cdktf.IResolveContext) interface{} {
