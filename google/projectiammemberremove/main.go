...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIamMemberRemove)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.projectIamMemberRemove.ProjectIamMemberRemoveConfig",
		reflect.TypeOf((*ProjectIamMemberRemoveConfig)(nil)).Elem(),
	)
}
