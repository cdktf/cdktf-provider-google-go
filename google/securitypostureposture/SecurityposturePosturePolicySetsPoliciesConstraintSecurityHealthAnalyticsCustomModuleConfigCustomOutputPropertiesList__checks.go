...
func (s *jsiiProxy_SecurityposturePosturePolicySetsPoliciesConstraintSecurityHealthAnalyticsCustomModuleConfigCustomOutputPropertiesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
