...
func (c *jsiiProxy_ClouddeployCustomTargetTypeCustomActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddeployCustomTargetTypeCustomActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
