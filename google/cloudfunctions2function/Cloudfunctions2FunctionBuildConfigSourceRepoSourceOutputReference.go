...
func (c *jsiiProxy_Cloudfunctions2FunctionBuildConfigSourceRepoSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_Cloudfunctions2FunctionBuildConfigSourceRepoSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
