...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/kmscryptokeyiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.33.0/docs/resources/kms_crypto_key_iam_policy google_kms_crypto_key_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.33.0/docs/resources/kms_crypto_key_iam_policy google_kms_crypto_key_iam_policy} Resource.
...
// Experimental.
func KmsCryptoKeyIamPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func KmsCryptoKeyIamPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KmsCryptoKeyIamPolicy) ToHclTerraform() interface{} {
	var returns interface{}
