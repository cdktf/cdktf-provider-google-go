...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolTemplateContainersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
