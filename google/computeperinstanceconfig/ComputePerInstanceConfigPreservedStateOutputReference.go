...
func (c *jsiiProxy_ComputePerInstanceConfigPreservedStateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputePerInstanceConfigPreservedStateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
