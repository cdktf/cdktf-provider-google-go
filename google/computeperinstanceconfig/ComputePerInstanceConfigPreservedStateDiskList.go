...
func (c *jsiiProxy_ComputePerInstanceConfigPreservedStateDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputePerInstanceConfigPreservedStateDiskList) Resolve(context cdktf.IResolveContext) interface{} {
