...
func (g *jsiiProxy_GkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
