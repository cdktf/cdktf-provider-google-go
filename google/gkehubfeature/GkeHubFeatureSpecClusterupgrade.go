...
type GkeHubFeatureSpecClusterupgrade struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/gke_hub_feature#upstream_fleets GkeHubFeature#upstream_fleets}
	UpstreamFleets *[]*string `field:"required" json:"upstreamFleets" yaml:"upstreamFleets"`
	// gke_upgrade_overrides block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/gke_hub_feature#gke_upgrade_overrides GkeHubFeature#gke_upgrade_overrides}
	GkeUpgradeOverrides interface{} `field:"optional" json:"gkeUpgradeOverrides" yaml:"gkeUpgradeOverrides"`
	// post_conditions block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.14.0/docs/resources/gke_hub_feature#post_conditions GkeHubFeature#post_conditions}
