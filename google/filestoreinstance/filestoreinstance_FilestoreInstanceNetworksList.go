...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/filestoreinstance/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

type FilestoreInstanceNetworksList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for FilestoreInstanceNetworksList
type jsiiProxy_FilestoreInstanceNetworksList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_FilestoreInstanceNetworksList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FilestoreInstanceNetworksList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FilestoreInstanceNetworksList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_FilestoreInstanceNetworksList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_FilestoreInstanceNetworksList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewFilestoreInstanceNetworksList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FilestoreInstanceNetworksList {
	...
	if err := validateNewFilestoreInstanceNetworksListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FilestoreInstanceNetworksList) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FilestoreInstanceNetworksList) Get(index *float64) FilestoreInstanceNetworksOutputReference {
	if err := f.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns FilestoreInstanceNetworksOutputReference
...
func (f *jsiiProxy_FilestoreInstanceNetworksList) ToString() *string {
	var returns *string
