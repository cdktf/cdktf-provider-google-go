...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/computepublicdelegatedprefix/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.25.0/docs/resources/compute_public_delegated_prefix google_compute_public_delegated_prefix}.
type ComputePublicDelegatedPrefix interface {
	...
	PutTimeouts(value *ComputePublicDelegatedPrefixTimeouts)
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) AllocatablePrefixLengthInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) IpCidrRange() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCidrRange",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) IpCidrRangeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCidrRangeInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Mode() *string {
	var returns *string
	_jsii_.Get(
		j,
		"mode",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) ModeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"modeInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Node() constructs.Node {
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) ParentPrefix() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentPrefix",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) ParentPrefixInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentPrefixInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputePublicDelegatedPrefix) Timeouts() ComputePublicDelegatedPrefixTimeoutsOutputReference {
	var returns ComputePublicDelegatedPrefixTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.25.0/docs/resources/compute_public_delegated_prefix google_compute_public_delegated_prefix} Resource.
func NewComputePublicDelegatedPrefix(scope constructs.Construct, id *string, config *ComputePublicDelegatedPrefixConfig) ComputePublicDelegatedPrefix {
	...
	if err := validateNewComputePublicDelegatedPrefixParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ComputePublicDelegatedPrefix_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.computePublicDelegatedPrefix.ComputePublicDelegatedPrefix",
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) PutTimeouts(value *ComputePublicDelegatedPrefixTimeouts) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetAllocatablePrefixLength() {
	_jsii_.InvokeVoid(
		c,
		"resetAllocatablePrefixLength",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetId() {
	_jsii_.InvokeVoid(
		c,
		"resetId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetIsLiveMigration() {
	_jsii_.InvokeVoid(
		c,
		"resetIsLiveMigration",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetMode() {
	_jsii_.InvokeVoid(
		c,
		"resetMode",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicDelegatedPrefix) ToString() *string {
	var returns *string
