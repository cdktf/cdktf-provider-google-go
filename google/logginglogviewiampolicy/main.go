...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LoggingLogViewIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.loggingLogViewIamPolicy.LoggingLogViewIamPolicyConfig",
		reflect.TypeOf((*LoggingLogViewIamPolicyConfig)(nil)).Elem(),
	)
}
