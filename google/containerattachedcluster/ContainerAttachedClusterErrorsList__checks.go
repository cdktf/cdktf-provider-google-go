...
func (c *jsiiProxy_ContainerAttachedClusterErrorsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_ContainerAttachedClusterErrorsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ContainerAttachedClusterErrorsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ContainerAttachedClusterErrorsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
