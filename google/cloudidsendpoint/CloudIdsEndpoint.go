...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v5/cloudidsendpoint/internal"
...
func (j *jsiiProxy_CloudIdsEndpoint) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CloudIdsEndpoint)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
