...
func (c *jsiiProxy_CertificateManagerDnsAuthorizationDnsResourceRecordList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_CertificateManagerDnsAuthorizationDnsResourceRecordList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
