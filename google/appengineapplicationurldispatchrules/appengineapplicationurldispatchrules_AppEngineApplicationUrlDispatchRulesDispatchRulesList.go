...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) InternalValue() interface{} {
...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList)SetWrapsSet(val *bool) {
...
func (a *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) Get(index *float64) AppEngineApplicationUrlDispatchRulesDispatchRulesOutputReference {
	if err := a.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns AppEngineApplicationUrlDispatchRulesDispatchRulesOutputReference
...
func (a *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (a *jsiiProxy_AppEngineApplicationUrlDispatchRulesDispatchRulesList) ToString() *string {
	var returns *string
