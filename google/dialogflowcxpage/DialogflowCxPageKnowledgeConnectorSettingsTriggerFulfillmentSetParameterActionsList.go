...
func (j *jsiiProxy_DialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList {
	_init_.Initialize()
...
func NewDialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList_Override(d DialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DialogflowCxPageKnowledgeConnectorSettingsTriggerFulfillmentSetParameterActionsList) Resolve(_context cdktf.IResolveContext) interface{} {
