...
func (d *jsiiProxy_DataprocJobPigConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocJobPigConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
