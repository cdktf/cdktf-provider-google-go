...
func (c *jsiiProxy_ComputeBackendServiceSecuritySettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeBackendServiceSecuritySettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
