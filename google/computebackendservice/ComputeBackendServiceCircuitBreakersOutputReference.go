...
func (c *jsiiProxy_ComputeBackendServiceCircuitBreakersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeBackendServiceCircuitBreakersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
