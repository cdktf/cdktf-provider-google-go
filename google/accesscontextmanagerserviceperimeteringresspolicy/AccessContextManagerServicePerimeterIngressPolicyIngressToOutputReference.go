...
func (a *jsiiProxy_AccessContextManagerServicePerimeterIngressPolicyIngressToOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeterIngressPolicyIngressToOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
