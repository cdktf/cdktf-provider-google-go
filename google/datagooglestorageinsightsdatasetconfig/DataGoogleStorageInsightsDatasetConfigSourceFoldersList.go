...
func (j *jsiiProxy_DataGoogleStorageInsightsDatasetConfigSourceFoldersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleStorageInsightsDatasetConfigSourceFoldersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleStorageInsightsDatasetConfigSourceFoldersList {
	_init_.Initialize()
...
func NewDataGoogleStorageInsightsDatasetConfigSourceFoldersList_Override(d DataGoogleStorageInsightsDatasetConfigSourceFoldersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleStorageInsightsDatasetConfigSourceFoldersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleStorageInsightsDatasetConfigSourceFoldersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleStorageInsightsDatasetConfigSourceFoldersList) Resolve(_context cdktf.IResolveContext) interface{} {
