...
func AccessContextManagerServicePerimeter_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateAccessContextManagerServicePerimeter_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) MoveFromId(id *string) {
...
func (a *jsiiProxy_AccessContextManagerServicePerimeter) MoveToId(id *string) {
