...
func (j *jsiiProxy_KmsCryptoKeyVersion) Attestation() KmsCryptoKeyVersionAttestationList {
	var returns KmsCryptoKeyVersionAttestationList
	_jsii_.Get(
		j,
		"attestation",
		&returns,
...
func (j *jsiiProxy_KmsCryptoKeyVersion) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) CryptoKey() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cryptoKey",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) CryptoKeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cryptoKeyInput",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) GenerateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"generateTime",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) Node() constructs.Node {
...
func (j *jsiiProxy_KmsCryptoKeyVersion) ProtectionLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
		"protectionLevel",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) StateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"stateInput",
...
func (j *jsiiProxy_KmsCryptoKeyVersion) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KmsCryptoKeyVersion) Timeouts() KmsCryptoKeyVersionTimeoutsOutputReference {
	var returns KmsCryptoKeyVersionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewKmsCryptoKeyVersion(scope constructs.Construct, id *string, config *KmsCryptoKeyVersionConfig) KmsCryptoKeyVersion {
	...
	if err := validateNewKmsCryptoKeyVersionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_KmsCryptoKeyVersion)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func KmsCryptoKeyVersion_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.kmsCryptoKeyVersion.KmsCryptoKeyVersion",
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetStringAttribute(terraformAttribute *string) *string {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) OverrideLogicalId(newLogicalId *string) {
...
func (k *jsiiProxy_KmsCryptoKeyVersion) ResetId() {
	_jsii_.InvokeVoid(
		k,
		"resetId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCryptoKeyVersion) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		k,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCryptoKeyVersion) ResetState() {
	_jsii_.InvokeVoid(
		k,
		"resetState",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCryptoKeyVersion) ResetTimeouts() {
	_jsii_.InvokeVoid(
		k,
		"resetTimeouts",
		nil, // no parameters
...
func (k *jsiiProxy_KmsCryptoKeyVersion) ToString() *string {
	var returns *string
