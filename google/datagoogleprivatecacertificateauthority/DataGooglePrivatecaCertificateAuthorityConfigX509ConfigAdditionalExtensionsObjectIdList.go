...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigX509ConfigAdditionalExtensionsObjectIdList) Resolve(context cdktf.IResolveContext) interface{} {
