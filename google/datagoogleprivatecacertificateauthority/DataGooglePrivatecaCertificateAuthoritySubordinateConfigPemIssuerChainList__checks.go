...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthoritySubordinateConfigPemIssuerChainList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
