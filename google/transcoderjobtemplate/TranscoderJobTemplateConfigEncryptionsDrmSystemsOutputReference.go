...
func (t *jsiiProxy_TranscoderJobTemplateConfigEncryptionsDrmSystemsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TranscoderJobTemplateConfigEncryptionsDrmSystemsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
