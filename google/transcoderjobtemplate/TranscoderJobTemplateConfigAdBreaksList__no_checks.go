...
func (t *jsiiProxy_TranscoderJobTemplateConfigAdBreaksList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_TranscoderJobTemplateConfigAdBreaksList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_TranscoderJobTemplateConfigAdBreaksList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
