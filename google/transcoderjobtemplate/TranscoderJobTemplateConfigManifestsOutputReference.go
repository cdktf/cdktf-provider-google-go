...
func (t *jsiiProxy_TranscoderJobTemplateConfigManifestsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TranscoderJobTemplateConfigManifestsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
