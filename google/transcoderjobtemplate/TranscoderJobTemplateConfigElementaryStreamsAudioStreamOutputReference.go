...
func (t *jsiiProxy_TranscoderJobTemplateConfigElementaryStreamsAudioStreamOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TranscoderJobTemplateConfigElementaryStreamsAudioStreamOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
