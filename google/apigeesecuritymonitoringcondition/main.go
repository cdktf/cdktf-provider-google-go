...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "conditionId", GoGetter: "ConditionId"},
			_jsii_.MemberProperty{JsiiProperty: "conditionIdInput", GoGetter: "ConditionIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "includeAllResources", GoGetter: "IncludeAllResources"},
			...
			_jsii_.MemberProperty{JsiiProperty: "totalDeployedResources", GoGetter: "TotalDeployedResources"},
