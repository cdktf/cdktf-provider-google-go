...
func (j *jsiiProxy_HealthcarePipelineJobBackfillPipelineJobOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewHealthcarePipelineJobBackfillPipelineJobOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HealthcarePipelineJobBackfillPipelineJobOutputReference {
	_init_.Initialize()
...
func NewHealthcarePipelineJobBackfillPipelineJobOutputReference_Override(h HealthcarePipelineJobBackfillPipelineJobOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_HealthcarePipelineJobBackfillPipelineJobOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (h *jsiiProxy_HealthcarePipelineJobBackfillPipelineJobOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcarePipelineJobBackfillPipelineJobOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (h *jsiiProxy_HealthcarePipelineJobBackfillPipelineJobOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcarePipelineJobBackfillPipelineJobOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
