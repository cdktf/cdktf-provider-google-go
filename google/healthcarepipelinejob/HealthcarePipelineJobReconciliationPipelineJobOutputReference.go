...
func (h *jsiiProxy_HealthcarePipelineJobReconciliationPipelineJobOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcarePipelineJobReconciliationPipelineJobOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
