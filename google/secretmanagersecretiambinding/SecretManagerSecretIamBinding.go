...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/secretmanagersecretiambinding/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/secret_manager_secret_iam_binding google_secret_manager_secret_iam_binding}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.16.0/docs/resources/secret_manager_secret_iam_binding google_secret_manager_secret_iam_binding} Resource.
...
// Generates CDKTF code for importing a SecretManagerSecretIamBinding resource upon running "cdktf plan <stack-name>".
func SecretManagerSecretIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecretManagerSecretIamBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecretManagerSecretIamBinding) MoveToId(id *string) {
