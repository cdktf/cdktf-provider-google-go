...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "discoveredWorkload", GoGetter: "DiscoveredWorkload"},
			_jsii_.MemberProperty{JsiiProperty: "discoveredWorkloadInput", GoGetter: "DiscoveredWorkloadInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "developerOwnersInput", GoGetter: "DeveloperOwnersInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "operatorOwnersInput", GoGetter: "OperatorOwnersInput"},
			_jsii_.MemberMethod{JsiiMethod: "putBusinessOwners", GoMethod: "PutBusinessOwners"},
			_jsii_.MemberMethod{JsiiMethod: "putCriticality", GoMethod: "PutCriticality"},
			_jsii_.MemberMethod{JsiiMethod: "putDeveloperOwners", GoMethod: "PutDeveloperOwners"},
			_jsii_.MemberMethod{JsiiMethod: "putEnvironment", GoMethod: "PutEnvironment"},
			_jsii_.MemberMethod{JsiiMethod: "putOperatorOwners", GoMethod: "PutOperatorOwners"},
			_jsii_.MemberMethod{JsiiMethod: "resetBusinessOwners", GoMethod: "ResetBusinessOwners"},
			_jsii_.MemberMethod{JsiiMethod: "resetCriticality", GoMethod: "ResetCriticality"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeveloperOwners", GoMethod: "ResetDeveloperOwners"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnvironment", GoMethod: "ResetEnvironment"},
			_jsii_.MemberMethod{JsiiMethod: "resetOperatorOwners", GoMethod: "ResetOperatorOwners"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
