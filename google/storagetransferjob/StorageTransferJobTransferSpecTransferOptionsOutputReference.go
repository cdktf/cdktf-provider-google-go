...
func (s *jsiiProxy_StorageTransferJobTransferSpecTransferOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTransferJobTransferSpecTransferOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
