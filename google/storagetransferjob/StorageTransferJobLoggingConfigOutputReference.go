...
func (s *jsiiProxy_StorageTransferJobLoggingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTransferJobLoggingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
