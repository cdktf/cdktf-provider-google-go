...
func (s *jsiiProxy_StorageTransferJobReplicationSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTransferJobReplicationSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
