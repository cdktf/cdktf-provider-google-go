...
func (c *jsiiProxy_ComputeRegionInstanceGroupManagerVersionTargetSizeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionInstanceGroupManagerVersionTargetSizeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
