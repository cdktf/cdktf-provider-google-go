...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/computepublicadvertisedprefix/internal"
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) DnsVerificationIp() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsVerificationIp",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) DnsVerificationIpInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dnsVerificationIpInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) IpCidrRange() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCidrRange",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) IpCidrRangeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCidrRangeInput",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) Node() constructs.Node {
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ComputePublicAdvertisedPrefix) Timeouts() ComputePublicAdvertisedPrefixTimeoutsOutputReference {
	var returns ComputePublicAdvertisedPrefixTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.18.0/docs/resources/compute_public_advertised_prefix google_compute_public_advertised_prefix} Resource.
func NewComputePublicAdvertisedPrefix(scope constructs.Construct, id *string, config *ComputePublicAdvertisedPrefixConfig) ComputePublicAdvertisedPrefix {
	...
	if err := validateNewComputePublicAdvertisedPrefixParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ComputePublicAdvertisedPrefix_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.computePublicAdvertisedPrefix.ComputePublicAdvertisedPrefix",
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetStringAttribute(terraformAttribute *string) *string {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) MoveFromId(id *string) {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) MoveToId(id *string) {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) OverrideLogicalId(newLogicalId *string) {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) PutTimeouts(value *ComputePublicAdvertisedPrefixTimeouts) {
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) ResetDescription() {
	_jsii_.InvokeVoid(
		c,
		"resetDescription",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		c,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) ResetProject() {
	_jsii_.InvokeVoid(
		c,
		"resetProject",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) ResetTimeouts() {
	_jsii_.InvokeVoid(
		c,
		"resetTimeouts",
		nil, // no parameters
...
func (c *jsiiProxy_ComputePublicAdvertisedPrefix) ToString() *string {
	var returns *string
