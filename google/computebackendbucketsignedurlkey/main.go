...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backendBucket", GoGetter: "BackendBucket"},
			_jsii_.MemberProperty{JsiiProperty: "backendBucketInput", GoGetter: "BackendBucketInput"},
