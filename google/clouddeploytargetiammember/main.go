...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ClouddeployTargetIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.clouddeployTargetIamMember.ClouddeployTargetIamMemberCondition",
		reflect.TypeOf((*ClouddeployTargetIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google.clouddeployTargetIamMember.ClouddeployTargetIamMemberConditionOutputReference",
		reflect.TypeOf((*ClouddeployTargetIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.clouddeployTargetIamMember.ClouddeployTargetIamMemberConfig",
		reflect.TypeOf((*ClouddeployTargetIamMemberConfig)(nil)).Elem(),
	)
}
