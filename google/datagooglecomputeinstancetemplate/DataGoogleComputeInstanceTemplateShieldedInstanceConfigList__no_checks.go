...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateShieldedInstanceConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateShieldedInstanceConfigList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
