...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/logginglogviewiambinding/internal"
...
type LoggingLogViewIamBinding interface {
	...
	PutCondition(value *LoggingLogViewIamBindingCondition)
	ResetCondition()
	ResetId()
	ResetLocation()
...
func (j *jsiiProxy_LoggingLogViewIamBinding) BucketInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"bucketInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Condition() LoggingLogViewIamBindingConditionOutputReference {
	var returns LoggingLogViewIamBindingConditionOutputReference
	_jsii_.Get(
		j,
		"condition",
		&returns,
...
func (j *jsiiProxy_LoggingLogViewIamBinding) ConditionInput() *LoggingLogViewIamBindingCondition {
	var returns *LoggingLogViewIamBindingCondition
	_jsii_.Get(
		j,
		"conditionInput",
		&returns,
...
func (j *jsiiProxy_LoggingLogViewIamBinding) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Members() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"members",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) MembersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"membersInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Node() constructs.Node {
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Parent() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parent",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) ParentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) Role() *string {
	var returns *string
	_jsii_.Get(
		j,
		"role",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) RoleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleInput",
...
func (j *jsiiProxy_LoggingLogViewIamBinding) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewLoggingLogViewIamBinding(scope constructs.Construct, id *string, config *LoggingLogViewIamBindingConfig) LoggingLogViewIamBinding {
	...
	if err := validateNewLoggingLogViewIamBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func LoggingLogViewIamBinding_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.loggingLogViewIamBinding.LoggingLogViewIamBinding",
...
func (l *jsiiProxy_LoggingLogViewIamBinding) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetStringAttribute(terraformAttribute *string) *string {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) MoveFromId(id *string) {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) MoveToId(id *string) {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) OverrideLogicalId(newLogicalId *string) {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) PutCondition(value *LoggingLogViewIamBindingCondition) {
...
func (l *jsiiProxy_LoggingLogViewIamBinding) ResetCondition() {
	_jsii_.InvokeVoid(
		l,
		"resetCondition",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLogViewIamBinding) ResetId() {
	_jsii_.InvokeVoid(
		l,
		"resetId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLogViewIamBinding) ResetLocation() {
	_jsii_.InvokeVoid(
		l,
		"resetLocation",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLogViewIamBinding) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		l,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (l *jsiiProxy_LoggingLogViewIamBinding) ToString() *string {
	var returns *string
