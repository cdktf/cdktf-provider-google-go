...
func (s *jsiiProxy_StorageDefaultObjectAccessControlProjectTeamList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StorageDefaultObjectAccessControlProjectTeamList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_StorageDefaultObjectAccessControlProjectTeamList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_StorageDefaultObjectAccessControlProjectTeamList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
