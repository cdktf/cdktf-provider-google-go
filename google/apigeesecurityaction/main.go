...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiProxies", GoGetter: "ApiProxies"},
			_jsii_.MemberProperty{JsiiProperty: "apiProxiesInput", GoGetter: "ApiProxiesInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "conditionConfig", GoGetter: "ConditionConfig"},
			_jsii_.MemberProperty{JsiiProperty: "conditionConfigInput", GoGetter: "ConditionConfigInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "flagInput", GoGetter: "FlagInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putConditionConfig", GoMethod: "PutConditionConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFlag", GoMethod: "ResetFlag"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetTtl", GoMethod: "ResetTtl"},
			_jsii_.MemberProperty{JsiiProperty: "securityActionId", GoGetter: "SecurityActionId"},
			_jsii_.MemberProperty{JsiiProperty: "securityActionIdInput", GoGetter: "SecurityActionIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiProductsInput", GoGetter: "ApiProductsInput"},
			_jsii_.MemberProperty{JsiiProperty: "asns", GoGetter: "Asns"},
			_jsii_.MemberProperty{JsiiProperty: "asnsInput", GoGetter: "AsnsInput"},
			_jsii_.MemberProperty{JsiiProperty: "botReasons", GoGetter: "BotReasons"},
			_jsii_.MemberProperty{JsiiProperty: "botReasonsInput", GoGetter: "BotReasonsInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "developerApps", GoGetter: "DeveloperApps"},
			_jsii_.MemberProperty{JsiiProperty: "developerAppsInput", GoGetter: "DeveloperAppsInput"},
			_jsii_.MemberProperty{JsiiProperty: "developers", GoGetter: "Developers"},
			_jsii_.MemberProperty{JsiiProperty: "developersInput", GoGetter: "DevelopersInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "httpMethodsInput", GoGetter: "HttpMethodsInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ipAddressRanges", GoGetter: "IpAddressRanges"},
			_jsii_.MemberProperty{JsiiProperty: "ipAddressRangesInput", GoGetter: "IpAddressRangesInput"},
			_jsii_.MemberProperty{JsiiProperty: "regionCodes", GoGetter: "RegionCodes"},
			_jsii_.MemberProperty{JsiiProperty: "regionCodesInput", GoGetter: "RegionCodesInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAccessTokens", GoMethod: "ResetAccessTokens"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBotReasons", GoMethod: "ResetBotReasons"},
			_jsii_.MemberMethod{JsiiMethod: "resetDeveloperApps", GoMethod: "ResetDeveloperApps"},
			_jsii_.MemberMethod{JsiiMethod: "resetDevelopers", GoMethod: "ResetDevelopers"},
			_jsii_.MemberMethod{JsiiMethod: "resetHttpMethods", GoMethod: "ResetHttpMethods"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpAddressRanges", GoMethod: "ResetIpAddressRanges"},
			_jsii_.MemberMethod{JsiiMethod: "resetRegionCodes", GoMethod: "ResetRegionCodes"},
			_jsii_.MemberMethod{JsiiMethod: "resetUserAgents", GoMethod: "ResetUserAgents"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
