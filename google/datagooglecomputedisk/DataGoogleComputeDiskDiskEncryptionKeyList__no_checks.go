...
func (d *jsiiProxy_DataGoogleComputeDiskDiskEncryptionKeyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGoogleComputeDiskDiskEncryptionKeyList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
