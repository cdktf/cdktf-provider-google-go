...
func (d *jsiiProxy_DataGoogleComputeDiskSourceImageEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeDiskSourceImageEncryptionKeyList) Resolve(context cdktf.IResolveContext) interface{} {
