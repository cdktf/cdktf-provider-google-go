...
func (d *jsiiProxy_DataGoogleContainerClusterNetworkPolicyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleContainerClusterNetworkPolicyList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
