...
func (d *jsiiProxy_DataGoogleContainerClusterNodeConfigLinuxNodeConfigList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigLinuxNodeConfigList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleContainerClusterNodeConfigLinuxNodeConfigList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
