...
func (d *jsiiProxy_DataGoogleContainerClusterClusterAutoscalingResourceLimitsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterClusterAutoscalingResourceLimitsList) Resolve(context cdktf.IResolveContext) interface{} {
