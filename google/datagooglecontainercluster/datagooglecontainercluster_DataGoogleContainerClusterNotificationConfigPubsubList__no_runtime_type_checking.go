...
func (d *jsiiProxy_DataGoogleContainerClusterNotificationConfigPubsubList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleContainerClusterNotificationConfigPubsubList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleContainerClusterNotificationConfigPubsubList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
