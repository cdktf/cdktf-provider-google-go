...
func (d *jsiiProxy_DataGoogleContainerClusterMaintenancePolicyRecurringWindowList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataGoogleContainerClusterMaintenancePolicyRecurringWindowList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleContainerClusterMaintenancePolicyRecurringWindowList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
