...
func (d *jsiiProxy_DataGoogleContainerClusterDefaultSnatStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterDefaultSnatStatusList) Resolve(context cdktf.IResolveContext) interface{} {
