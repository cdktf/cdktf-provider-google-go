...
func (j *jsiiProxy_ComputeInstanceNetworkInterfaceOutputReference) NetworkAttachment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkAttachment",
...
func (j *jsiiProxy_ComputeInstanceNetworkInterfaceOutputReference) NetworkAttachmentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (c *jsiiProxy_ComputeInstanceNetworkInterfaceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceNetworkInterfaceOutputReference) ResetNetworkAttachment() {
	_jsii_.InvokeVoid(
		c,
		"resetNetworkAttachment",
		nil, // no parameters
...
func (c *jsiiProxy_ComputeInstanceNetworkInterfaceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
