...
func (c *jsiiProxy_ComputeInstanceNetworkInterfaceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_ComputeInstanceNetworkInterfaceList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_ComputeInstanceNetworkInterfaceList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ComputeInstanceNetworkInterface:
		val := val.(*[]*ComputeInstanceNetworkInterface)
	...
	case []*ComputeInstanceNetworkInterface:
		val_ := val.([]*ComputeInstanceNetworkInterface)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
