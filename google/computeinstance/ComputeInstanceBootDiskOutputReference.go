...
func (c *jsiiProxy_ComputeInstanceBootDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceBootDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
