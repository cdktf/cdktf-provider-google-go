...
func (d *jsiiProxy_DataGoogleComputeSecurityPolicyRuleMatchConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleComputeSecurityPolicyRuleMatchConfigList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeSecurityPolicyRuleMatchConfigList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeSecurityPolicyRuleMatchConfigList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
