...
func (c *jsiiProxy_ChronicleDataAccessScopeDeniedDataAccessLabelsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ChronicleDataAccessScopeDeniedDataAccessLabelsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
