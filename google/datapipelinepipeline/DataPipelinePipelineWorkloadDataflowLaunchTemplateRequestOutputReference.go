...
func (d *jsiiProxy_DataPipelinePipelineWorkloadDataflowLaunchTemplateRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataPipelinePipelineWorkloadDataflowLaunchTemplateRequestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
