...
func (d *jsiiProxy_DataPipelinePipelineWorkloadOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataPipelinePipelineWorkloadOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
