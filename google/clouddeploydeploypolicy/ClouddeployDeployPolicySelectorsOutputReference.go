...
func (c *jsiiProxy_ClouddeployDeployPolicySelectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddeployDeployPolicySelectorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
