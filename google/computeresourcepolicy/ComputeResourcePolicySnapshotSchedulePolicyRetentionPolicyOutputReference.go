...
func (c *jsiiProxy_ComputeResourcePolicySnapshotSchedulePolicyRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeResourcePolicySnapshotSchedulePolicyRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
