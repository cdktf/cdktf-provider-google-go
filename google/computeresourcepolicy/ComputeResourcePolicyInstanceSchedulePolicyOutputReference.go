...
func (c *jsiiProxy_ComputeResourcePolicyInstanceSchedulePolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeResourcePolicyInstanceSchedulePolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
