...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiHubInstanceId", GoGetter: "ApiHubInstanceId"},
			_jsii_.MemberProperty{JsiiProperty: "apiHubInstanceIdInput", GoGetter: "ApiHubInstanceIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableSearch", GoGetter: "DisableSearch"},
			_jsii_.MemberProperty{JsiiProperty: "disableSearchInput", GoGetter: "DisableSearchInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDisableSearch", GoMethod: "ResetDisableSearch"},
			_jsii_.MemberMethod{JsiiMethod: "resetEncryptionType", GoMethod: "ResetEncryptionType"},
			_jsii_.MemberMethod{JsiiMethod: "resetVertexLocation", GoMethod: "ResetVertexLocation"},
