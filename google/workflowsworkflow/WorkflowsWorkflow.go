...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/workflowsworkflow/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.46.0/docs/resources/workflows_workflow google_workflows_workflow} Resource.
...
func (w *jsiiProxy_WorkflowsWorkflow) ResetDeletionProtection() {
	_jsii_.InvokeVoid(
		w,
		"resetDeletionProtection",
		nil, // no parameters
