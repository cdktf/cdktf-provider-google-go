...
type LookerInstanceMaintenanceWindow struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/looker_instance#day_of_week LookerInstance#day_of_week}
