...
func (c *jsiiProxy_CloudbuildTriggerBuildSourceRepoSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerBuildSourceRepoSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
