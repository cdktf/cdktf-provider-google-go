...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerBuildArtifactsNpmPackagesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
