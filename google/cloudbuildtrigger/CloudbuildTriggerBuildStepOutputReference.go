...
func (c *jsiiProxy_CloudbuildTriggerBuildStepOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerBuildStepOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
