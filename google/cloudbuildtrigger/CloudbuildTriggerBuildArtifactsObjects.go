...
type CloudbuildTriggerBuildArtifactsObjects struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.3.0/docs/resources/cloudbuild_trigger#location CloudbuildTrigger#location}
