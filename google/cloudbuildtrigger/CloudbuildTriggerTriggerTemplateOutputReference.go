...
func (c *jsiiProxy_CloudbuildTriggerTriggerTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudbuildTriggerTriggerTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
