...
func (n *jsiiProxy_NetworkServicesEdgeCacheKeysetValidationSharedKeysList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeysetValidationSharedKeysList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	...
	case []*NetworkServicesEdgeCacheKeysetValidationSharedKeys:
		val_ := val.([]*NetworkServicesEdgeCacheKeysetValidationSharedKeys)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeysetValidationSharedKeysList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_NetworkServicesEdgeCacheKeysetValidationSharedKeysList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
