...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/oracledatabasecloudvmcluster/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/oracle_database_cloud_vm_cluster google_oracle_database_cloud_vm_cluster}.
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) BackupSubnetCidrInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Cidr() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cidr",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) CidrInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cidrInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) CloudVmClusterId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"cloudVmClusterId",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) CloudVmClusterIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) ExadataInfrastructure() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) ExadataInfrastructureInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) GcpOracleZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"gcpOracleZone",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Labels() *map[string]*string {
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Node() constructs.Node {
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Properties() OracleDatabaseCloudVmClusterPropertiesOutputReference {
	var returns OracleDatabaseCloudVmClusterPropertiesOutputReference
	_jsii_.Get(
		j,
		"properties",
		&returns,
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) PropertiesInput() *OracleDatabaseCloudVmClusterProperties {
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_OracleDatabaseCloudVmCluster) Timeouts() OracleDatabaseCloudVmClusterTimeoutsOutputReference {
	var returns OracleDatabaseCloudVmClusterTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.44.0/docs/resources/oracle_database_cloud_vm_cluster google_oracle_database_cloud_vm_cluster} Resource.
func NewOracleDatabaseCloudVmCluster(scope constructs.Construct, id *string, config *OracleDatabaseCloudVmClusterConfig) OracleDatabaseCloudVmCluster {
	...
	if err := validateNewOracleDatabaseCloudVmClusterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetStringAttribute(terraformAttribute *string) *string {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) MoveFromId(id *string) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) MoveToId(id *string) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) OverrideLogicalId(newLogicalId *string) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) PutProperties(value *OracleDatabaseCloudVmClusterProperties) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) PutTimeouts(value *OracleDatabaseCloudVmClusterTimeouts) {
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetDisplayName() {
	_jsii_.InvokeVoid(
		o,
		"resetDisplayName",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetId() {
	_jsii_.InvokeVoid(
		o,
		"resetId",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetLabels() {
	_jsii_.InvokeVoid(
		o,
		"resetLabels",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		o,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetProject() {
	_jsii_.InvokeVoid(
		o,
		"resetProject",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetProperties() {
	_jsii_.InvokeVoid(
		o,
		"resetProperties",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ResetTimeouts() {
	_jsii_.InvokeVoid(
		o,
		"resetTimeouts",
		nil, // no parameters
...
func (o *jsiiProxy_OracleDatabaseCloudVmCluster) ToString() *string {
	var returns *string
