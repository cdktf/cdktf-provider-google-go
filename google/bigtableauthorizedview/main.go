...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSubsetView", GoMethod: "ResetSubsetView"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "subsetView", GoGetter: "SubsetView"},
			_jsii_.MemberProperty{JsiiProperty: "subsetViewInput", GoGetter: "SubsetViewInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "qualifierPrefixes", GoGetter: "QualifierPrefixes"},
			_jsii_.MemberProperty{JsiiProperty: "qualifierPrefixesInput", GoGetter: "QualifierPrefixesInput"},
			_jsii_.MemberProperty{JsiiProperty: "qualifiers", GoGetter: "Qualifiers"},
			_jsii_.MemberProperty{JsiiProperty: "qualifiersInput", GoGetter: "QualifiersInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetQualifierPrefixes", GoMethod: "ResetQualifierPrefixes"},
			_jsii_.MemberMethod{JsiiMethod: "resetQualifiers", GoMethod: "ResetQualifiers"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "familySubsets", GoGetter: "FamilySubsets"},
			_jsii_.MemberProperty{JsiiProperty: "familySubsetsInput", GoGetter: "FamilySubsetsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putFamilySubsets", GoMethod: "PutFamilySubsets"},
			_jsii_.MemberMethod{JsiiMethod: "resetFamilySubsets", GoMethod: "ResetFamilySubsets"},
			_jsii_.MemberMethod{JsiiMethod: "resetRowPrefixes", GoMethod: "ResetRowPrefixes"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "rowPrefixes", GoGetter: "RowPrefixes"},
			_jsii_.MemberProperty{JsiiProperty: "rowPrefixesInput", GoGetter: "RowPrefixesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
