...
func (j *jsiiProxy_DataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList {
	_init_.Initialize()
...
func NewDataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList_Override(d DataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBigqueryTableTableConstraintsForeignKeysReferencedTableList) Resolve(_context cdktf.IResolveContext) interface{} {
