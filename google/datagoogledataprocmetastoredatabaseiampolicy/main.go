...
package datagoogledataprocmetastoredatabaseiampolicy
...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.dataGoogleDataprocMetastoreDatabaseIamPolicy.DataGoogleDataprocMetastoreDatabaseIamPolicyConfig",
