...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/kmscryptokeyiammember/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.29.0/docs/resources/kms_crypto_key_iam_member google_kms_crypto_key_iam_member} Resource.
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KmsCryptoKeyIamMember) ToHclTerraform() interface{} {
	var returns interface{}
