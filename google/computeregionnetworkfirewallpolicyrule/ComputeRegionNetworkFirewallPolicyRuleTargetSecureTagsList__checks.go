...
func (c *jsiiProxy_ComputeRegionNetworkFirewallPolicyRuleTargetSecureTagsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_ComputeRegionNetworkFirewallPolicyRuleTargetSecureTagsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
