...
func (l *jsiiProxy_LoggingFolderBucketConfigIndexConfigsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (l *jsiiProxy_LoggingFolderBucketConfigIndexConfigsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
