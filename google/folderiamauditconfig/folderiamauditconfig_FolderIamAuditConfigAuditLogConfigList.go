...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) InternalValue() interface{} {
...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_FolderIamAuditConfigAuditLogConfigList)SetWrapsSet(val *bool) {
...
func (f *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) Get(index *float64) FolderIamAuditConfigAuditLogConfigOutputReference {
	if err := f.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns FolderIamAuditConfigAuditLogConfigOutputReference
...
func (f *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (f *jsiiProxy_FolderIamAuditConfigAuditLogConfigList) ToString() *string {
	var returns *string
