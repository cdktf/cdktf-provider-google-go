...
func (j *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList)SetWrapsSet(val *bool) {
...
func (c *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) Get(index *float64) ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesOutputReference
...
func (c *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (c *jsiiProxy_ComputeInterconnectGroupPhysicalStructureMetrosFacilitiesList) ToString() *string {
	var returns *string
