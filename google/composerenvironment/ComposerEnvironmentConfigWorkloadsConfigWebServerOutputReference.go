...
func (c *jsiiProxy_ComposerEnvironmentConfigWorkloadsConfigWebServerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComposerEnvironmentConfigWorkloadsConfigWebServerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
