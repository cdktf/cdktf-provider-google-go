...
func (c *jsiiProxy_ComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
