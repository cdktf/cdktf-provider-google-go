...
func (c *jsiiProxy_ComposerEnvironmentConfigNodeConfigIpAllocationPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComposerEnvironmentConfigNodeConfigIpAllocationPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
