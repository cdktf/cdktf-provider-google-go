...
type DialogflowCxTestCaseTestCaseConversationTurnsUserInputInput struct {
	// dtmf block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/dialogflow_cx_test_case#dtmf DialogflowCxTestCase#dtmf}
	Dtmf *DialogflowCxTestCaseTestCaseConversationTurnsUserInputInputDtmf `field:"optional" json:"dtmf" yaml:"dtmf"`
	// event block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/dialogflow_cx_test_case#event DialogflowCxTestCase#event}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.1.0/docs/resources/dialogflow_cx_test_case#language_code DialogflowCxTestCase#language_code}
