...
func (d *jsiiProxy_DialogflowCxTestCaseTestConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxTestCaseTestConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
