...
type AccessContextManagerServicePerimeterResourceConfig struct {
	// Experimental.
	...
	Timeouts *AccessContextManagerServicePerimeterResourceTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
