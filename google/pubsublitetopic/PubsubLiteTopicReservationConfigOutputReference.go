...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/pubsublitetopic/internal"
...
type PubsubLiteTopicReservationConfigOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *PubsubLiteTopicReservationConfig
	SetInternalValue(val *PubsubLiteTopicReservationConfig)
	// Experimental.
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) InternalValue() *PubsubLiteTopicReservationConfig {
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) ThroughputReservation() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) ThroughputReservationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) ResetThroughputReservation() {
	_jsii_.InvokeVoid(
		p,
		"resetThroughputReservation",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_PubsubLiteTopicReservationConfigOutputReference) ToString() *string {
	var returns *string
