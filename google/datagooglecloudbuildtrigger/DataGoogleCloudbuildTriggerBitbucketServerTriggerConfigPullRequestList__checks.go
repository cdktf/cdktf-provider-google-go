...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBitbucketServerTriggerConfigPullRequestList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBitbucketServerTriggerConfigPullRequestList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
