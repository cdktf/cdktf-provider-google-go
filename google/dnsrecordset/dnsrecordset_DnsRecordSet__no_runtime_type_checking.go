...
func (j *jsiiProxy_DnsRecordSet) validateSetManagedZoneParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DnsRecordSet) validateSetProjectParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DnsRecordSet) validateSetRrdatasParameters(val *[]*string) error {
	return nil
}
