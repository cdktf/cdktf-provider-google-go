...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v3/dnsrecordset/internal"
...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DnsRecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DnsRecordSetRoutingPolicyWrrHealthCheckedTargetsInternalLoadBalancersList) Resolve(_context cdktf.IResolveContext) interface{} {
