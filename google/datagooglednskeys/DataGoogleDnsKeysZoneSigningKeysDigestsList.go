...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/datagooglednskeys/internal"
...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysDigestsList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysDigestsList)SetInternalValue(val interface{}) {
