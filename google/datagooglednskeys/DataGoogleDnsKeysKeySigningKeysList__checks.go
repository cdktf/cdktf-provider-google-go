...
func (d *jsiiProxy_DataGoogleDnsKeysKeySigningKeysList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleDnsKeysKeySigningKeysList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
