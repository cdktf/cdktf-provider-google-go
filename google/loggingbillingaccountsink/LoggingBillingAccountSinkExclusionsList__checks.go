...
func (l *jsiiProxy_LoggingBillingAccountSinkExclusionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (l *jsiiProxy_LoggingBillingAccountSinkExclusionsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_LoggingBillingAccountSinkExclusionsList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
...
func (j *jsiiProxy_LoggingBillingAccountSinkExclusionsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_LoggingBillingAccountSinkExclusionsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
