...
func (c *jsiiProxy_CloudRunV2WorkerPoolTemplateVolumesEmptyDirOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudRunV2WorkerPoolTemplateVolumesEmptyDirOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
