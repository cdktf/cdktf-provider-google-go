...
type ContainerNodePoolNodeConfigEphemeralStorageLocalSsdConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.40.0/docs/resources/container_node_pool#data_cache_count ContainerNodePool#data_cache_count}
