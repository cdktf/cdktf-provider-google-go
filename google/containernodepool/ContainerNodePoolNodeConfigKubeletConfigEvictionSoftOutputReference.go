...
func (c *jsiiProxy_ContainerNodePoolNodeConfigKubeletConfigEvictionSoftOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerNodePoolNodeConfigKubeletConfigEvictionSoftOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
