...
func (c *jsiiProxy_ContainerNodePoolNodeConfigTaintList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_ContainerNodePoolNodeConfigTaintList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
