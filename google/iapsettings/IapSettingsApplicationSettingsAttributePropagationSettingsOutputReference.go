...
func (i *jsiiProxy_IapSettingsApplicationSettingsAttributePropagationSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IapSettingsApplicationSettingsAttributePropagationSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
