...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/vpcaccessconnector/internal"
...
type jsiiProxy_VpcAccessConnector struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_VpcAccessConnector) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_VpcAccessConnector) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VpcAccessConnector) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_VpcAccessConnector) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VpcAccessConnector) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VpcAccessConnector) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VpcAccessConnector) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VpcAccessConnector) IpCidrRange() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCidrRange",
...
func (j *jsiiProxy_VpcAccessConnector) IpCidrRangeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ipCidrRangeInput",
...
func (j *jsiiProxy_VpcAccessConnector) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_VpcAccessConnector) MaxThroughputInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"maxThroughputInput",
...
func (j *jsiiProxy_VpcAccessConnector) MinThroughput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minThroughput",
...
func (j *jsiiProxy_VpcAccessConnector) MinThroughputInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"minThroughputInput",
...
func (j *jsiiProxy_VpcAccessConnector) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_VpcAccessConnector) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_VpcAccessConnector) Network() *string {
	var returns *string
	_jsii_.Get(
		j,
		"network",
...
func (j *jsiiProxy_VpcAccessConnector) NetworkInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkInput",
...
func (j *jsiiProxy_VpcAccessConnector) Node() constructs.Node {
...
func (j *jsiiProxy_VpcAccessConnector) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_VpcAccessConnector) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_VpcAccessConnector) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_VpcAccessConnector) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VpcAccessConnector) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VpcAccessConnector) SelfLink() *string {
	var returns *string
	_jsii_.Get(
		j,
		"selfLink",
...
func (j *jsiiProxy_VpcAccessConnector) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_VpcAccessConnector) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VpcAccessConnector) Timeouts() VpcAccessConnectorTimeoutsOutputReference {
	var returns VpcAccessConnectorTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewVpcAccessConnector(scope constructs.Construct, id *string, config *VpcAccessConnectorConfig) VpcAccessConnector {
	...
	if err := validateNewVpcAccessConnectorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VpcAccessConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVpcAccessConnector_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VpcAccessConnector_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.vpcAccessConnector.VpcAccessConnector",
...
func (v *jsiiProxy_VpcAccessConnector) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VpcAccessConnector) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcAccessConnector) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VpcAccessConnector) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VpcAccessConnector) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VpcAccessConnector) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VpcAccessConnector) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VpcAccessConnector) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VpcAccessConnector) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VpcAccessConnector) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VpcAccessConnector) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpcAccessConnector) MoveFromId(id *string) {
...
func (v *jsiiProxy_VpcAccessConnector) MoveToId(id *string) {
...
func (v *jsiiProxy_VpcAccessConnector) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VpcAccessConnector) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetIpCidrRange() {
	_jsii_.InvokeVoid(
		v,
		"resetIpCidrRange",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetMinThroughput() {
	_jsii_.InvokeVoid(
		v,
		"resetMinThroughput",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetNetwork() {
	_jsii_.InvokeVoid(
		v,
		"resetNetwork",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetProject() {
	_jsii_.InvokeVoid(
		v,
		"resetProject",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
...
func (v *jsiiProxy_VpcAccessConnector) ToString() *string {
	var returns *string
