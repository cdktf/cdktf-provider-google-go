...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/vpcaccessconnector/internal"
...
func (j *jsiiProxy_VpcAccessConnector) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VpcAccessConnector)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
