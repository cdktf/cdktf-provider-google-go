...
type PrivatecaCertificateConfigX509ConfigAdditionalExtensions struct {
	...
	ObjectId *PrivatecaCertificateConfigX509ConfigAdditionalExtensionsObjectId `field:"required" json:"objectId" yaml:"objectId"`
