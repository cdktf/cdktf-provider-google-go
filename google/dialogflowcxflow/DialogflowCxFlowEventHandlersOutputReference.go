...
func (d *jsiiProxy_DialogflowCxFlowEventHandlersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DialogflowCxFlowEventHandlersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
