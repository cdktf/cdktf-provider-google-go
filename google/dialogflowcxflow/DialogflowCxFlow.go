...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/dialogflowcxflow/internal"
...
func (j *jsiiProxy_DialogflowCxFlow) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DialogflowCxFlow)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
