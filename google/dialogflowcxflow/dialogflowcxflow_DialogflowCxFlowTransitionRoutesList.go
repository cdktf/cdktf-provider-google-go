...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/dialogflowcxflow/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

type DialogflowCxFlowTransitionRoutesList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for DialogflowCxFlowTransitionRoutesList
type jsiiProxy_DialogflowCxFlowTransitionRoutesList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DialogflowCxFlowTransitionRoutesList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDialogflowCxFlowTransitionRoutesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DialogflowCxFlowTransitionRoutesList {
	...
	if err := validateNewDialogflowCxFlowTransitionRoutesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DialogflowCxFlowTransitionRoutesList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DialogflowCxFlowTransitionRoutesList) Get(index *float64) DialogflowCxFlowTransitionRoutesOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DialogflowCxFlowTransitionRoutesOutputReference
...
func (d *jsiiProxy_DialogflowCxFlowTransitionRoutesList) ToString() *string {
	var returns *string
