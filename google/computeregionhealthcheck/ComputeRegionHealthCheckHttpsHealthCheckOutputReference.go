...
func (c *jsiiProxy_ComputeRegionHealthCheckHttpsHealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionHealthCheckHttpsHealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
