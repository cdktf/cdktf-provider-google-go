...
func (a *jsiiProxy_AlloydbInstanceQueryInsightsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlloydbInstanceQueryInsightsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
