...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/datagooglemonitoringclusteristioservice/internal"
...
func (d *jsiiProxy_DataGoogleMonitoringClusterIstioServiceTelemetryList) Resolve(context cdktf.IResolveContext) interface{} {
