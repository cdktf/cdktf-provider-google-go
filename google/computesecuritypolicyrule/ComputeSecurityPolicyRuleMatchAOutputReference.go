...
func (c *jsiiProxy_ComputeSecurityPolicyRuleMatchAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleMatchAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
