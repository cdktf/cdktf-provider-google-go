...
func (i *jsiiProxy_IamWorkforcePoolProviderOidcWebSsoConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamWorkforcePoolProviderOidcWebSsoConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
