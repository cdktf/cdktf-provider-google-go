...
type OsConfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfig struct {
	...
	GcsObject *OsConfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject `field:"optional" json:"gcsObject" yaml:"gcsObject"`
