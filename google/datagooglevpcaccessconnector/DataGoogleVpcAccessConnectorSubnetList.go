...
func (d *jsiiProxy_DataGoogleVpcAccessConnectorSubnetList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleVpcAccessConnectorSubnetList) Resolve(context cdktf.IResolveContext) interface{} {
