...
func (c *jsiiProxy_ComputeInstanceTemplateDiskSourceImageEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceTemplateDiskSourceImageEncryptionKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
