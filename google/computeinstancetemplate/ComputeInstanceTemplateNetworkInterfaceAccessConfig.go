...
type ComputeInstanceTemplateNetworkInterfaceAccessConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/4.65.2/docs/resources/compute_instance_template#nat_ip ComputeInstanceTemplate#nat_ip}
