...
func (c *jsiiProxy_ComputeInstanceTemplateDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeInstanceTemplateDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
