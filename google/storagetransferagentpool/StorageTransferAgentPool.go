...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/storagetransferagentpool/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/storage_transfer_agent_pool google_storage_transfer_agent_pool}.
...
func (j *jsiiProxy_StorageTransferAgentPool) BandwidthLimit() StorageTransferAgentPoolBandwidthLimitOutputReference {
	var returns StorageTransferAgentPoolBandwidthLimitOutputReference
	_jsii_.Get(
		j,
		"bandwidthLimit",
		&returns,
...
func (j *jsiiProxy_StorageTransferAgentPool) BandwidthLimitInput() *StorageTransferAgentPoolBandwidthLimit {
	var returns *StorageTransferAgentPoolBandwidthLimit
	_jsii_.Get(
		j,
		"bandwidthLimitInput",
		&returns,
...
func (j *jsiiProxy_StorageTransferAgentPool) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_StorageTransferAgentPool) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_StorageTransferAgentPool) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_StorageTransferAgentPool) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StorageTransferAgentPool) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_StorageTransferAgentPool) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_StorageTransferAgentPool) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_StorageTransferAgentPool) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_StorageTransferAgentPool) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_StorageTransferAgentPool) Node() constructs.Node {
...
func (j *jsiiProxy_StorageTransferAgentPool) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_StorageTransferAgentPool) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_StorageTransferAgentPool) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_StorageTransferAgentPool) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_StorageTransferAgentPool) Timeouts() StorageTransferAgentPoolTimeoutsOutputReference {
	var returns StorageTransferAgentPoolTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.15.0/docs/resources/storage_transfer_agent_pool google_storage_transfer_agent_pool} Resource.
func NewStorageTransferAgentPool(scope constructs.Construct, id *string, config *StorageTransferAgentPoolConfig) StorageTransferAgentPool {
	...
	if err := validateNewStorageTransferAgentPoolParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func StorageTransferAgentPool_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.storageTransferAgentPool.StorageTransferAgentPool",
...
func (s *jsiiProxy_StorageTransferAgentPool) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetStringAttribute(terraformAttribute *string) *string {
...
func (s *jsiiProxy_StorageTransferAgentPool) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (s *jsiiProxy_StorageTransferAgentPool) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageTransferAgentPool) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageTransferAgentPool) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_StorageTransferAgentPool) PutBandwidthLimit(value *StorageTransferAgentPoolBandwidthLimit) {
	if err := s.validatePutBandwidthLimitParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_StorageTransferAgentPool) PutTimeouts(value *StorageTransferAgentPoolTimeouts) {
...
func (s *jsiiProxy_StorageTransferAgentPool) ResetBandwidthLimit() {
	_jsii_.InvokeVoid(
		s,
		"resetBandwidthLimit",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTransferAgentPool) ResetDisplayName() {
	_jsii_.InvokeVoid(
		s,
		"resetDisplayName",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTransferAgentPool) ResetId() {
	_jsii_.InvokeVoid(
		s,
		"resetId",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTransferAgentPool) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTransferAgentPool) ResetProject() {
	_jsii_.InvokeVoid(
		s,
		"resetProject",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTransferAgentPool) ResetTimeouts() {
	_jsii_.InvokeVoid(
		s,
		"resetTimeouts",
		nil, // no parameters
...
func (s *jsiiProxy_StorageTransferAgentPool) ToString() *string {
	var returns *string
