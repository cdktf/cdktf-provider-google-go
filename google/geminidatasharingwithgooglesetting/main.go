...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataSharingWithGoogleSettingId", GoGetter: "DataSharingWithGoogleSettingId"},
			_jsii_.MemberProperty{JsiiProperty: "dataSharingWithGoogleSettingIdInput", GoGetter: "DataSharingWithGoogleSettingIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "effectiveLabels", GoGetter: "EffectiveLabels"},
			_jsii_.MemberProperty{JsiiProperty: "enableDataSharing", GoGetter: "EnableDataSharing"},
			_jsii_.MemberProperty{JsiiProperty: "enableDataSharingInput", GoGetter: "EnableDataSharingInput"},
			_jsii_.MemberProperty{JsiiProperty: "enablePreviewDataSharing", GoGetter: "EnablePreviewDataSharing"},
			_jsii_.MemberProperty{JsiiProperty: "enablePreviewDataSharingInput", GoGetter: "EnablePreviewDataSharingInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEnableDataSharing", GoMethod: "ResetEnableDataSharing"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnablePreviewDataSharing", GoMethod: "ResetEnablePreviewDataSharing"},
