...
type OsConfigOsPolicyAssignmentOsPoliciesResourceGroupsResourcesPkgMsiSource struct {
	// Defaults to false.
	//
	...
	Gcs *OsConfigOsPolicyAssignmentOsPoliciesResourceGroupsResourcesPkgMsiSourceGcs `field:"optional" json:"gcs" yaml:"gcs"`
	...
	Remote *OsConfigOsPolicyAssignmentOsPoliciesResourceGroupsResourcesPkgMsiSourceRemote `field:"optional" json:"remote" yaml:"remote"`
}
