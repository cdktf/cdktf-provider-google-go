...
func (o *jsiiProxy_OsConfigOsPolicyAssignmentInstanceFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OsConfigOsPolicyAssignmentInstanceFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
