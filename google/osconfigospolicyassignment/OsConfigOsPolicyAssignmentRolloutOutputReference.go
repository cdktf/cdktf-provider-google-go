...
func (o *jsiiProxy_OsConfigOsPolicyAssignmentRolloutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OsConfigOsPolicyAssignmentRolloutOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
