...
func (d *jsiiProxy_DataGoogleOracleDatabaseAutonomousDatabasesAutonomousDatabasesPropertiesConnectionStringsProfilesList) Resolve(context cdktf.IResolveContext) interface{} {
