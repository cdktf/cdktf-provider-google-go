...
func (j *jsiiProxy_CloudbuildBitbucketServerConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google/r/cloudbuild_bitbucket_server_config google_cloudbuild_bitbucket_server_config} Resource.
...
func (j *jsiiProxy_CloudbuildBitbucketServerConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
