...
func (c *jsiiProxy_ComputeUrlMapPathMatcherRouteRulesUrlRedirectOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapPathMatcherRouteRulesUrlRedirectOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
