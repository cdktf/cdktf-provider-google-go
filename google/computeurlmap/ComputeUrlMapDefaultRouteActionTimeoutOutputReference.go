...
func (c *jsiiProxy_ComputeUrlMapDefaultRouteActionTimeoutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapDefaultRouteActionTimeoutOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
