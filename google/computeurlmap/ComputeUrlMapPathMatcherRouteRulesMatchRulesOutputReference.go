...
func (c *jsiiProxy_ComputeUrlMapPathMatcherRouteRulesMatchRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapPathMatcherRouteRulesMatchRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
