...
func (c *jsiiProxy_ComputeUrlMapPathMatcherOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapPathMatcherOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
