...
func (c *jsiiProxy_ComputeUrlMapHeaderActionRequestHeadersToAddOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeUrlMapHeaderActionRequestHeadersToAddOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
