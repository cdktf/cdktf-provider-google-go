...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) EnvId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"envId",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) EnvIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"envIdInput",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) Node() constructs.Node {
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigeeEnvironmentAddonsConfig) Timeouts() ApigeeEnvironmentAddonsConfigTimeoutsOutputReference {
	var returns ApigeeEnvironmentAddonsConfigTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.36.0/docs/resources/apigee_environment_addons_config google_apigee_environment_addons_config} Resource.
func NewApigeeEnvironmentAddonsConfig(scope constructs.Construct, id *string, config *ApigeeEnvironmentAddonsConfigConfig) ApigeeEnvironmentAddonsConfig {
	...
	if err := validateNewApigeeEnvironmentAddonsConfigParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func ApigeeEnvironmentAddonsConfig_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.apigeeEnvironmentAddonsConfig.ApigeeEnvironmentAddonsConfig",
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) MoveToId(id *string) {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) OverrideLogicalId(newLogicalId *string) {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) PutTimeouts(value *ApigeeEnvironmentAddonsConfigTimeouts) {
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) ResetAnalyticsEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetAnalyticsEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		a,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeEnvironmentAddonsConfig) ToString() *string {
	var returns *string
