...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/cloudassetorganizationfeed/internal"
...
func (j *jsiiProxy_CloudAssetOrganizationFeed) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_CloudAssetOrganizationFeed)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
