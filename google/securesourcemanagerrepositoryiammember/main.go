...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecureSourceManagerRepositoryIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.secureSourceManagerRepositoryIamMember.SecureSourceManagerRepositoryIamMemberCondition",
		reflect.TypeOf((*SecureSourceManagerRepositoryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecureSourceManagerRepositoryIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.secureSourceManagerRepositoryIamMember.SecureSourceManagerRepositoryIamMemberConfig",
		reflect.TypeOf((*SecureSourceManagerRepositoryIamMemberConfig)(nil)).Elem(),
	)
}
