...
type VertexAiIndexMetadata struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/vertex_ai_index#contents_delta_uri VertexAiIndex#contents_delta_uri}
	ContentsDeltaUri *string `field:"required" json:"contentsDeltaUri" yaml:"contentsDeltaUri"`
	// config block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/vertex_ai_index#config VertexAiIndex#config}
