...
func (v *jsiiProxy_VertexAiIndexMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiIndexMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
