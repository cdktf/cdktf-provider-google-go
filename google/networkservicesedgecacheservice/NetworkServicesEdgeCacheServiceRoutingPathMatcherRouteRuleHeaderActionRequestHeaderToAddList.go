...
func (n *jsiiProxy_NetworkServicesEdgeCacheServiceRoutingPathMatcherRouteRuleHeaderActionRequestHeaderToAddList) Resolve(context cdktf.IResolveContext) interface{} {
