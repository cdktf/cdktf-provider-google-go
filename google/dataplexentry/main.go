...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aspectsInput", GoGetter: "AspectsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "entrySource", GoGetter: "EntrySource"},
			_jsii_.MemberProperty{JsiiProperty: "entrySourceInput", GoGetter: "EntrySourceInput"},
			_jsii_.MemberProperty{JsiiProperty: "entryType", GoGetter: "EntryType"},
			_jsii_.MemberProperty{JsiiProperty: "entryTypeInput", GoGetter: "EntryTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "fullyQualifiedName", GoGetter: "FullyQualifiedName"},
			_jsii_.MemberProperty{JsiiProperty: "fullyQualifiedNameInput", GoGetter: "FullyQualifiedNameInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "parentEntry", GoGetter: "ParentEntry"},
			_jsii_.MemberProperty{JsiiProperty: "parentEntryInput", GoGetter: "ParentEntryInput"},
			_jsii_.MemberProperty{JsiiProperty: "project", GoGetter: "Project"},
			_jsii_.MemberProperty{JsiiProperty: "projectInput", GoGetter: "ProjectInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putAspects", GoMethod: "PutAspects"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEntrySource", GoMethod: "ResetEntrySource"},
			_jsii_.MemberMethod{JsiiMethod: "resetFullyQualifiedName", GoMethod: "ResetFullyQualifiedName"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocation", GoMethod: "ResetLocation"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParentEntry", GoMethod: "ResetParentEntry"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aspectKey", GoGetter: "AspectKey"},
			_jsii_.MemberProperty{JsiiProperty: "aspectKeyInput", GoGetter: "AspectKeyInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putAspect", GoMethod: "PutAspect"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putAncestors", GoMethod: "PutAncestors"},
			_jsii_.MemberMethod{JsiiMethod: "resetAncestors", GoMethod: "ResetAncestors"},
