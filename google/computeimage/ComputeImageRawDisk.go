...
type ComputeImageRawDisk struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/compute_image#container_type ComputeImage#container_type}
	ContainerType *string `field:"optional" json:"containerType" yaml:"containerType"`
	// An optional SHA1 checksum of the disk image before unpackaging.
	//
	// This is provided by the client when the disk image is created.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/compute_image#sha1 ComputeImage#sha1}
