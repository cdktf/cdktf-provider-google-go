...
func (c *jsiiProxy_ComputeImageShieldedInstanceInitialStateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeImageShieldedInstanceInitialStateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
