...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v5/bigqueryanalyticshubdataexchangeiambinding/internal"
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/google/r/bigquery_analytics_hub_data_exchange_iam_binding google_bigquery_analytics_hub_data_exchange_iam_binding} Resource.
...
func (j *jsiiProxy_BigqueryAnalyticsHubDataExchangeIamBinding)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
