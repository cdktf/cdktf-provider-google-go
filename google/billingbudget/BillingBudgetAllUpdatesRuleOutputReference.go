...
func (b *jsiiProxy_BillingBudgetAllUpdatesRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BillingBudgetAllUpdatesRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
