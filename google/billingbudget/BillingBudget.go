...
func (b *jsiiProxy_BillingBudget) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BillingBudget) MoveFromId(id *string) {
...
func (b *jsiiProxy_BillingBudget) MoveToId(id *string) {
