...
func (c *jsiiProxy_ComputeRegionSecurityPolicyAdvancedOptionsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionSecurityPolicyAdvancedOptionsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
