...
func (c *jsiiProxy_ComputeRegionSecurityPolicyRulesNetworkMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionSecurityPolicyRulesNetworkMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
