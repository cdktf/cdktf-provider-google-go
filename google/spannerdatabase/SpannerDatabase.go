...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/spannerdatabase/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.24.0/docs/resources/spanner_database google_spanner_database} Resource.
...
func SpannerDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSpannerDatabase_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpannerDatabase) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpannerDatabase) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SpannerDatabase) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpannerDatabase) MoveToId(id *string) {
