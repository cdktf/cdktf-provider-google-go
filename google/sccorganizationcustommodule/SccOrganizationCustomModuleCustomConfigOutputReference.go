...
func (s *jsiiProxy_SccOrganizationCustomModuleCustomConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SccOrganizationCustomModuleCustomConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
