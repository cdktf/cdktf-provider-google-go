...
func (g *jsiiProxy_GeminiCodeToolsSettingEnabledToolList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GeminiCodeToolsSettingEnabledToolList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*GeminiCodeToolsSettingEnabledTool:
		val_ := val.([]*GeminiCodeToolsSettingEnabledTool)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_GeminiCodeToolsSettingEnabledToolList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GeminiCodeToolsSettingEnabledToolList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
