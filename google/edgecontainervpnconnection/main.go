...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableHighAvailability", GoGetter: "EnableHighAvailability"},
			_jsii_.MemberProperty{JsiiProperty: "enableHighAvailabilityInput", GoGetter: "EnableHighAvailabilityInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "natGatewayIp", GoGetter: "NatGatewayIp"},
			_jsii_.MemberProperty{JsiiProperty: "natGatewayIpInput", GoGetter: "NatGatewayIpInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNatGatewayIp", GoMethod: "ResetNatGatewayIp"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVpcProject", GoMethod: "ResetVpcProject"},
