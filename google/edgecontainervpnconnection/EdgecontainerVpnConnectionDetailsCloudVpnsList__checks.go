...
func (e *jsiiProxy_EdgecontainerVpnConnectionDetailsCloudVpnsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_EdgecontainerVpnConnectionDetailsCloudVpnsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_EdgecontainerVpnConnectionDetailsCloudVpnsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
