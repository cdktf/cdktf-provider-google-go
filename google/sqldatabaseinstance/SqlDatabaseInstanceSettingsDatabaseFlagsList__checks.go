...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsDatabaseFlagsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SqlDatabaseInstanceSettingsDatabaseFlagsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_SqlDatabaseInstanceSettingsDatabaseFlagsList) validateSetInternalValueParameters(val interface{}) error {
	...
	case *[]*SqlDatabaseInstanceSettingsDatabaseFlags:
		val := val.(*[]*SqlDatabaseInstanceSettingsDatabaseFlags)
	...
	case []*SqlDatabaseInstanceSettingsDatabaseFlags:
		val_ := val.([]*SqlDatabaseInstanceSettingsDatabaseFlags)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*SqlDatabaseInstanceSettingsDatabaseFlags; received %#v (a %T)", val, val)
		}
	}
