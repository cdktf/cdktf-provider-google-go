...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "buildServiceAccountInput", GoGetter: "BuildServiceAccountInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBuildServiceAccount", GoMethod: "ResetBuildServiceAccount"},
