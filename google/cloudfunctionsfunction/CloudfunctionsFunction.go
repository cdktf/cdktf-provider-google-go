...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/cloudfunctions_function google_cloudfunctions_function}.
...
func (j *jsiiProxy_CloudfunctionsFunction) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_CloudfunctionsFunction) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.15.0/docs/resources/cloudfunctions_function google_cloudfunctions_function} Resource.
...
func CloudfunctionsFunction_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CloudfunctionsFunction) ImportFrom(id *string, provider cdktf.TerraformProvider) {
