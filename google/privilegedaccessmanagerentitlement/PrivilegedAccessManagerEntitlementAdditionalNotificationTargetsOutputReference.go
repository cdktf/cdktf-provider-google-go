...
func (p *jsiiProxy_PrivilegedAccessManagerEntitlementAdditionalNotificationTargetsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivilegedAccessManagerEntitlementAdditionalNotificationTargetsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
