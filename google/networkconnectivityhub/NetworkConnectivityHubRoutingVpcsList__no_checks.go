...
func (n *jsiiProxy_NetworkConnectivityHubRoutingVpcsList) validateGetParameters(index *float64) error {
	return nil
}

func (n *jsiiProxy_NetworkConnectivityHubRoutingVpcsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}

func (j *jsiiProxy_NetworkConnectivityHubRoutingVpcsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_NetworkConnectivityHubRoutingVpcsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
