...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/datagoogledataplexzoneiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.11.0/docs/data-sources/dataplex_zone_iam_policy google_dataplex_zone_iam_policy}.
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) DataplexZone() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataplexZone",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) DataplexZoneInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataplexZoneInput",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Lake() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lake",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) LakeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"lakeInput",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleDataplexZoneIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.11.0/docs/data-sources/dataplex_zone_iam_policy google_dataplex_zone_iam_policy} Data Source.
func NewDataGoogleDataplexZoneIamPolicy(scope constructs.Construct, id *string, config *DataGoogleDataplexZoneIamPolicyConfig) DataGoogleDataplexZoneIamPolicy {
	...
	if err := validateNewDataGoogleDataplexZoneIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleDataplexZoneIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleDataplexZoneIamPolicy.DataGoogleDataplexZoneIamPolicy",
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) ResetLocation() {
	_jsii_.InvokeVoid(
		d,
		"resetLocation",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleDataplexZoneIamPolicy) ToString() *string {
	var returns *string
