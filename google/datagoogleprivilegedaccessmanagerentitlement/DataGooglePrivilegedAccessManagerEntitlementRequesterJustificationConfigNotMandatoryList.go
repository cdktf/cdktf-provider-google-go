...
func (d *jsiiProxy_DataGooglePrivilegedAccessManagerEntitlementRequesterJustificationConfigNotMandatoryList) Resolve(_context cdktf.IResolveContext) interface{} {
