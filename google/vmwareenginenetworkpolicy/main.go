...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "edgeServicesCidrInput", GoGetter: "EdgeServicesCidrInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putExternalIp", GoMethod: "PutExternalIp"},
