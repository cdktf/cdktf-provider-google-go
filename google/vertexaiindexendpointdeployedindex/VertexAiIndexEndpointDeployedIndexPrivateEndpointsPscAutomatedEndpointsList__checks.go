...
func (v *jsiiProxy_VertexAiIndexEndpointDeployedIndexPrivateEndpointsPscAutomatedEndpointsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
