...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "interceptEndpointGroupAssociationId", GoGetter: "InterceptEndpointGroupAssociationId"},
			_jsii_.MemberProperty{JsiiProperty: "interceptEndpointGroupAssociationIdInput", GoGetter: "InterceptEndpointGroupAssociationIdInput"},
