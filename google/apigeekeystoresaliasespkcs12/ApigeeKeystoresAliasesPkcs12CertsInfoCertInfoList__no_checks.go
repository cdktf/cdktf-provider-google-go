...
func (a *jsiiProxy_ApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) validateGetParameters(index *float64) error {
	return nil
}

func (a *jsiiProxy_ApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}

func (j *jsiiProxy_ApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
