...
func (d *jsiiProxy_DataGoogleBigqueryDatasetAccessConditionList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleBigqueryDatasetAccessConditionList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataGoogleBigqueryDatasetAccessConditionList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleBigqueryDatasetAccessConditionList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
