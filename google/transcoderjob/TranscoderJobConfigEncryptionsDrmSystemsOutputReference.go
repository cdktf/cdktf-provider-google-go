...
func (t *jsiiProxy_TranscoderJobConfigEncryptionsDrmSystemsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TranscoderJobConfigEncryptionsDrmSystemsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
