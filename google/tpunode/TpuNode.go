...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v15/tpunode/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/tpu_node google_tpu_node} Resource.
...
func (t *jsiiProxy_TpuNode) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TpuNode) MoveFromId(id *string) {
...
func (t *jsiiProxy_TpuNode) MoveToId(id *string) {
