...
func (t *jsiiProxy_TpuNodeNetworkEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TpuNodeNetworkEndpointsList) Resolve(context cdktf.IResolveContext) interface{} {
