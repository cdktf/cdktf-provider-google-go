...
func (a *jsiiProxy_ApigeeAppGroupAttributesList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_ApigeeAppGroupAttributesList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ApigeeAppGroupAttributesList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
