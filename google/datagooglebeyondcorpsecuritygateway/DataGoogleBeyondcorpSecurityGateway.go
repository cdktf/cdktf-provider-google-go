...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/datagooglebeyondcorpsecuritygateway/internal"
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) DelegatingServiceAccount() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) ExternalIps() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"externalIps",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) Hubs() DataGoogleBeyondcorpSecurityGatewayHubsList {
	var returns DataGoogleBeyondcorpSecurityGatewayHubsList
	_jsii_.Get(
		j,
		"hubs",
		&returns,
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) SecurityGatewayId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"securityGatewayId",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) SecurityGatewayIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/data-sources/beyondcorp_security_gateway google_beyondcorp_security_gateway} Data Source.
func NewDataGoogleBeyondcorpSecurityGateway(scope constructs.Construct, id *string, config *DataGoogleBeyondcorpSecurityGatewayConfig) DataGoogleBeyondcorpSecurityGateway {
	...
	if err := validateNewDataGoogleBeyondcorpSecurityGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleBeyondcorpSecurityGateway_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleBeyondcorpSecurityGateway.DataGoogleBeyondcorpSecurityGateway",
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGateway) ToString() *string {
	var returns *string
