...
func (h *jsiiProxy_HealthcareConsentStoreTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareConsentStoreTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
