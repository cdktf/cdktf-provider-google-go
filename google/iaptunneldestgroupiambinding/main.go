...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapTunnelDestGroupIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.iapTunnelDestGroupIamBinding.IapTunnelDestGroupIamBindingCondition",
		reflect.TypeOf((*IapTunnelDestGroupIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google.iapTunnelDestGroupIamBinding.IapTunnelDestGroupIamBindingConditionOutputReference",
		reflect.TypeOf((*IapTunnelDestGroupIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.iapTunnelDestGroupIamBinding.IapTunnelDestGroupIamBindingConfig",
		reflect.TypeOf((*IapTunnelDestGroupIamBindingConfig)(nil)).Elem(),
	)
}
