...
type VertexAiDatasetEncryptionSpecOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *VertexAiDatasetEncryptionSpec
	SetInternalValue(val *VertexAiDatasetEncryptionSpec)
	KmsKeyName() *string
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) InternalValue() *VertexAiDatasetEncryptionSpec {
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) KmsKeyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyName",
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) KmsKeyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyNameInput",
...
func (j *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) ComputeFqn() *string {
	var returns *string
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) ResetKmsKeyName() {
	_jsii_.InvokeVoid(
		v,
		"resetKmsKeyName",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiDatasetEncryptionSpecOutputReference) ToString() *string {
	var returns *string
