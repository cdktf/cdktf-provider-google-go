...
func (b *jsiiProxy_BigqueryDatasetAccessDatasetAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryDatasetAccessDatasetAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
