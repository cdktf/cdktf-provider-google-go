...
func (j *jsiiProxy_DataGoogleComputeRegionNetworkEndpointGroup) PscData() DataGoogleComputeRegionNetworkEndpointGroupPscDataList {
	var returns DataGoogleComputeRegionNetworkEndpointGroupPscDataList
	_jsii_.Get(
		j,
		"pscData",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.17.0/docs/data-sources/compute_region_network_endpoint_group google_compute_region_network_endpoint_group} Data Source.
