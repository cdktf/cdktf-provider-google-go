...
func (d *jsiiProxy_DataGoogleStorageBucketLoggingList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGoogleStorageBucketLoggingList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
