...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "commitmentId", GoGetter: "CommitmentId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "existingReservations", GoGetter: "ExistingReservations"},
			_jsii_.MemberProperty{JsiiProperty: "existingReservationsInput", GoGetter: "ExistingReservationsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putLicenseResource", GoMethod: "PutLicenseResource"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExistingReservations", GoMethod: "ResetExistingReservations"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetLicenseResource", GoMethod: "ResetLicenseResource"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "coresPerLicense", GoGetter: "CoresPerLicense"},
			_jsii_.MemberProperty{JsiiProperty: "coresPerLicenseInput", GoGetter: "CoresPerLicenseInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCoresPerLicense", GoMethod: "ResetCoresPerLicense"},
