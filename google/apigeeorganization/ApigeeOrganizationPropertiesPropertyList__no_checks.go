...
func (a *jsiiProxy_ApigeeOrganizationPropertiesPropertyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (a *jsiiProxy_ApigeeOrganizationPropertiesPropertyList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
