...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v13/apigeeorganization/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.23.0/docs/resources/apigee_organization google_apigee_organization} Resource.
...
func ApigeeOrganization_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateApigeeOrganization_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApigeeOrganization) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_ApigeeOrganization) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApigeeOrganization) MoveFromId(id *string) {
...
func (a *jsiiProxy_ApigeeOrganization) MoveToId(id *string) {
