...
func (d *jsiiProxy_DiscoveryEngineChatEngineChatEngineMetadataList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DiscoveryEngineChatEngineChatEngineMetadataList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DiscoveryEngineChatEngineChatEngineMetadataList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
