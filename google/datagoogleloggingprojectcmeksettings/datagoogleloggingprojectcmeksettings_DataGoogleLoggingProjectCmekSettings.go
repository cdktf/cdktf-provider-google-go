...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v4/datagoogleloggingprojectcmeksettings/internal"
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGoogleLoggingProjectCmekSettings)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
