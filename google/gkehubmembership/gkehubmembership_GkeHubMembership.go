...
type GkeHubMembership interface {
	...
	PutAuthority(value *GkeHubMembershipAuthority)
	PutEndpoint(value *GkeHubMembershipEndpoint)
	PutTimeouts(value *GkeHubMembershipTimeouts)
	ResetAuthority()
	ResetEndpoint()
	ResetId()
	ResetLabels()
...
func (j *jsiiProxy_GkeHubMembership) Authority() GkeHubMembershipAuthorityOutputReference {
	var returns GkeHubMembershipAuthorityOutputReference
	_jsii_.Get(
		j,
		"authority",
		&returns,
...
func (j *jsiiProxy_GkeHubMembership) AuthorityInput() *GkeHubMembershipAuthority {
...
func (j *jsiiProxy_GkeHubMembership) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_GkeHubMembership) Endpoint() GkeHubMembershipEndpointOutputReference {
	var returns GkeHubMembershipEndpointOutputReference
	_jsii_.Get(
		j,
		"endpoint",
		&returns,
...
func (j *jsiiProxy_GkeHubMembership) EndpointInput() *GkeHubMembershipEndpoint {
...
func (j *jsiiProxy_GkeHubMembership) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_GkeHubMembership) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_GkeHubMembership) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_GkeHubMembership) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_GkeHubMembership) Labels() *map[string]*string {
...
func (j *jsiiProxy_GkeHubMembership) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GkeHubMembership) MembershipId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipId",
...
func (j *jsiiProxy_GkeHubMembership) MembershipIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"membershipIdInput",
...
func (j *jsiiProxy_GkeHubMembership) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_GkeHubMembership) Node() constructs.Node {
...
func (j *jsiiProxy_GkeHubMembership) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_GkeHubMembership) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_GkeHubMembership) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GkeHubMembership) Timeouts() GkeHubMembershipTimeoutsOutputReference {
	var returns GkeHubMembershipTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func NewGkeHubMembership(scope constructs.Construct, id *string, config *GkeHubMembershipConfig) GkeHubMembership {
	...
	if err := validateNewGkeHubMembershipParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GkeHubMembership) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (g *jsiiProxy_GkeHubMembership) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (g *jsiiProxy_GkeHubMembership) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (g *jsiiProxy_GkeHubMembership) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (g *jsiiProxy_GkeHubMembership) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (g *jsiiProxy_GkeHubMembership) GetStringAttribute(terraformAttribute *string) *string {
...
func (g *jsiiProxy_GkeHubMembership) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (g *jsiiProxy_GkeHubMembership) OverrideLogicalId(newLogicalId *string) {
...
func (g *jsiiProxy_GkeHubMembership) PutAuthority(value *GkeHubMembershipAuthority) {
...
func (g *jsiiProxy_GkeHubMembership) PutEndpoint(value *GkeHubMembershipEndpoint) {
...
func (g *jsiiProxy_GkeHubMembership) PutTimeouts(value *GkeHubMembershipTimeouts) {
...
func (g *jsiiProxy_GkeHubMembership) ResetAuthority() {
	_jsii_.InvokeVoid(
		g,
		"resetAuthority",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ResetEndpoint() {
	_jsii_.InvokeVoid(
		g,
		"resetEndpoint",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ResetId() {
	_jsii_.InvokeVoid(
		g,
		"resetId",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		g,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ResetProject() {
	_jsii_.InvokeVoid(
		g,
		"resetProject",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ResetTimeouts() {
	_jsii_.InvokeVoid(
		g,
		"resetTimeouts",
		nil, // no parameters
...
func (g *jsiiProxy_GkeHubMembership) ToString() *string {
	var returns *string
