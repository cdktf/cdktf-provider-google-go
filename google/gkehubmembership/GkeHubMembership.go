...
func (j *jsiiProxy_GkeHubMembership) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_GkeHubMembership) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.36.1/docs/resources/gke_hub_membership google_gke_hub_membership} Resource.
...
func (g *jsiiProxy_GkeHubMembership) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GkeHubMembership) MoveFromId(id *string) {
...
func (g *jsiiProxy_GkeHubMembership) MoveToId(id *string) {
...
func (g *jsiiProxy_GkeHubMembership) ResetLocation() {
	_jsii_.InvokeVoid(
		g,
		"resetLocation",
		nil, // no parameters
