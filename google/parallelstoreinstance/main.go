...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "daosVersion", GoGetter: "DaosVersion"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "description", GoGetter: "Description"},
			_jsii_.MemberProperty{JsiiProperty: "descriptionInput", GoGetter: "DescriptionInput"},
			_jsii_.MemberProperty{JsiiProperty: "directoryStripeLevel", GoGetter: "DirectoryStripeLevel"},
			_jsii_.MemberProperty{JsiiProperty: "directoryStripeLevelInput", GoGetter: "DirectoryStripeLevelInput"},
			_jsii_.MemberProperty{JsiiProperty: "effectiveLabels", GoGetter: "EffectiveLabels"},
			_jsii_.MemberProperty{JsiiProperty: "effectiveReservedIpRange", GoGetter: "EffectiveReservedIpRange"},
			_jsii_.MemberProperty{JsiiProperty: "fileStripeLevel", GoGetter: "FileStripeLevel"},
			_jsii_.MemberProperty{JsiiProperty: "fileStripeLevelInput", GoGetter: "FileStripeLevelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDirectoryStripeLevel", GoMethod: "ResetDirectoryStripeLevel"},
			_jsii_.MemberMethod{JsiiMethod: "resetFileStripeLevel", GoMethod: "ResetFileStripeLevel"},
