...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KmsEkmConnectionIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.kmsEkmConnectionIamMember.KmsEkmConnectionIamMemberCondition",
		reflect.TypeOf((*KmsEkmConnectionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google.kmsEkmConnectionIamMember.KmsEkmConnectionIamMemberConditionOutputReference",
		reflect.TypeOf((*KmsEkmConnectionIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.kmsEkmConnectionIamMember.KmsEkmConnectionIamMemberConfig",
		reflect.TypeOf((*KmsEkmConnectionIamMemberConfig)(nil)).Elem(),
	)
}
