...
func (v *jsiiProxy_VertexAiEndpointPrivateServiceConnectConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiEndpointPrivateServiceConnectConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
