...
func (v *jsiiProxy_VertexAiEndpointDeployedModelsDedicatedResourcesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VertexAiEndpointDeployedModelsDedicatedResourcesList) Resolve(context cdktf.IResolveContext) interface{} {
