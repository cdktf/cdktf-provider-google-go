...
func (v *jsiiProxy_VertexAiEndpointDeployedModelsDedicatedResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VertexAiEndpointDeployedModelsDedicatedResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
