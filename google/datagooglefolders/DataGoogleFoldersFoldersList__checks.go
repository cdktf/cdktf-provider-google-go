...
func (d *jsiiProxy_DataGoogleFoldersFoldersList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleFoldersFoldersList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
