...
func (g *jsiiProxy_GkeBackupBackupPlanBackupConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeBackupBackupPlanBackupConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
