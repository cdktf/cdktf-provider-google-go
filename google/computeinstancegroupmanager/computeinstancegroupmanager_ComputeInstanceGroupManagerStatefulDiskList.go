...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/computeinstancegroupmanager/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

type ComputeInstanceGroupManagerStatefulDiskList interface {
	cdktf.ComplexList
...
// The jsii proxy struct for ComputeInstanceGroupManagerStatefulDiskList
type jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewComputeInstanceGroupManagerStatefulDiskList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeInstanceGroupManagerStatefulDiskList {
	...
	if err := validateNewComputeInstanceGroupManagerStatefulDiskListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) ComputeFqn() *string {
	var returns *string
...
func (c *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) Get(index *float64) ComputeInstanceGroupManagerStatefulDiskOutputReference {
	if err := c.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns ComputeInstanceGroupManagerStatefulDiskOutputReference
...
func (c *jsiiProxy_ComputeInstanceGroupManagerStatefulDiskList) ToString() *string {
	var returns *string
