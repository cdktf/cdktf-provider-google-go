...
func (c *jsiiProxy_ComputeInstanceGroupManager) validatePutNamedPortParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ComputeInstanceGroupManagerNamedPort:
		value := value.(*[]*ComputeInstanceGroupManagerNamedPort)
	...
	case []*ComputeInstanceGroupManagerNamedPort:
		value_ := value.([]*ComputeInstanceGroupManagerNamedPort)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ComputeInstanceGroupManagerNamedPort; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeInstanceGroupManager) validatePutStatefulDiskParameters(value interface{}) error {
	...
	case *[]*ComputeInstanceGroupManagerStatefulDisk:
		value := value.(*[]*ComputeInstanceGroupManagerStatefulDisk)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ComputeInstanceGroupManagerStatefulDisk:
		value_ := value.([]*ComputeInstanceGroupManagerStatefulDisk)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ComputeInstanceGroupManagerStatefulDisk; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeInstanceGroupManager) validatePutStatefulExternalIpParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ComputeInstanceGroupManagerStatefulExternalIp:
		value := value.(*[]*ComputeInstanceGroupManagerStatefulExternalIp)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ComputeInstanceGroupManagerStatefulExternalIp:
		value_ := value.([]*ComputeInstanceGroupManagerStatefulExternalIp)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ComputeInstanceGroupManagerStatefulExternalIp; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_ComputeInstanceGroupManager) validatePutStatefulInternalIpParameters(value interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ComputeInstanceGroupManagerStatefulInternalIp:
		value := value.(*[]*ComputeInstanceGroupManagerStatefulInternalIp)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ComputeInstanceGroupManagerStatefulInternalIp:
		value_ := value.([]*ComputeInstanceGroupManagerStatefulInternalIp)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (c *jsiiProxy_ComputeInstanceGroupManager) validatePutVersionParameters(value interface{}) error {
	...
	case *[]*ComputeInstanceGroupManagerVersion:
		value := value.(*[]*ComputeInstanceGroupManagerVersion)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ComputeInstanceGroupManagerVersion:
		value_ := value.([]*ComputeInstanceGroupManagerVersion)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ComputeInstanceGroupManagerVersion; received %#v (a %T)", value, value)
		}
	}
