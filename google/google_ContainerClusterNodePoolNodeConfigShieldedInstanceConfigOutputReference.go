...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) EnableIntegrityMonitoring() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) EnableIntegrityMonitoringInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) EnableSecureBoot() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enableSecureBoot",
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) EnableSecureBootInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference)SetEnableIntegrityMonitoring(val interface{}) {
...
func (j *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference)SetEnableSecureBoot(val interface{}) {
...
func (c *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (c *jsiiProxy_ContainerClusterNodePoolNodeConfigShieldedInstanceConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
