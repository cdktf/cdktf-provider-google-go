...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/datagooglefolderorganizationpolicy/internal"
...
func (d *jsiiProxy_DataGoogleFolderOrganizationPolicyBooleanPolicyList) Resolve(context cdktf.IResolveContext) interface{} {
