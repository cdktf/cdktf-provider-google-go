...
func (b *jsiiProxy_BigqueryJobLoadOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryJobLoadOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
