...
func (b *jsiiProxy_BigqueryJobExtractSourceTableOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryJobExtractSourceTableOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
