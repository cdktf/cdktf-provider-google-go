...
func (b *jsiiProxy_BigqueryJobStatusList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (b *jsiiProxy_BigqueryJobStatusList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
