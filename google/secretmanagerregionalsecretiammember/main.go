...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretManagerRegionalSecretIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_SecretManagerRegionalSecretIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.secretManagerRegionalSecretIamMember.SecretManagerRegionalSecretIamMemberCondition",
		reflect.TypeOf((*SecretManagerRegionalSecretIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-google.secretManagerRegionalSecretIamMember.SecretManagerRegionalSecretIamMemberConditionOutputReference",
		reflect.TypeOf((*SecretManagerRegionalSecretIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-google.secretManagerRegionalSecretIamMember.SecretManagerRegionalSecretIamMemberConfig",
		reflect.TypeOf((*SecretManagerRegionalSecretIamMemberConfig)(nil)).Elem(),
	)
}
