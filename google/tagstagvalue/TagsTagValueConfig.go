...
type TagsTagValueConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/tags_tag_value#short_name TagsTagValue#short_name}
	ShortName *string `field:"required" json:"shortName" yaml:"shortName"`
	// User-assigned description of the TagValue. Must not exceed 256 characters.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/tags_tag_value#description TagsTagValue#description}
	Description *string `field:"optional" json:"description" yaml:"description"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.45.0/docs/resources/tags_tag_value#id TagsTagValue#id}.
	//
