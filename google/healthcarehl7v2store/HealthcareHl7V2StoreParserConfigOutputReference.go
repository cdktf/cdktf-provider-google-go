...
func (h *jsiiProxy_HealthcareHl7V2StoreParserConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareHl7V2StoreParserConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
