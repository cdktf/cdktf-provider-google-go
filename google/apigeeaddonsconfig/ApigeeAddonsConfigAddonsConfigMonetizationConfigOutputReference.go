...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v10/apigeeaddonsconfig/internal"
...
type ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference interface {
	...
	SetInternalValue(val *ApigeeAddonsConfigAddonsConfigMonetizationConfig)
	// Experimental.
...
func (j *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) InternalValue() *ApigeeAddonsConfigAddonsConfigMonetizationConfig {
...
func (j *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_ApigeeAddonsConfigAddonsConfigMonetizationConfigOutputReference) ToString() *string {
	var returns *string
