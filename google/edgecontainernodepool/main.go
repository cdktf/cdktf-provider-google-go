...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "localDiskEncryption", GoGetter: "LocalDiskEncryption"},
			_jsii_.MemberProperty{JsiiProperty: "localDiskEncryptionInput", GoGetter: "LocalDiskEncryptionInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "nodeLocation", GoGetter: "NodeLocation"},
			_jsii_.MemberProperty{JsiiProperty: "nodeLocationInput", GoGetter: "NodeLocationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putLocalDiskEncryption", GoMethod: "PutLocalDiskEncryption"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMachineFilter", GoMethod: "ResetMachineFilter"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kmsKeyActiveVersion", GoGetter: "KmsKeyActiveVersion"},
