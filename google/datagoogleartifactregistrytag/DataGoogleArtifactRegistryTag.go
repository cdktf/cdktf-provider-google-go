...
package datagoogleartifactregistrytag
...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/datagoogleartifactregistrytag/internal"
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) PackageName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageName",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) PackageNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"packageNameInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) RepositoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) RepositoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) TagName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagName",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) TagNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tagNameInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTag) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.0/docs/data-sources/artifact_registry_tag google_artifact_registry_tag} Data Source.
func NewDataGoogleArtifactRegistryTag(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryTagConfig) DataGoogleArtifactRegistryTag {
	...
	if err := validateNewDataGoogleArtifactRegistryTagParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleArtifactRegistryTag_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleArtifactRegistryTag.DataGoogleArtifactRegistryTag",
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTag) ToString() *string {
	var returns *string
