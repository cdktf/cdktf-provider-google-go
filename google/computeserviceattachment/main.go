...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "propagatedConnectionLimit", GoGetter: "PropagatedConnectionLimit"},
			...
			_jsii_.MemberProperty{JsiiProperty: "reconcileConnections", GoGetter: "ReconcileConnections"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPropagatedConnectionLimit", GoMethod: "ResetPropagatedConnectionLimit"},
