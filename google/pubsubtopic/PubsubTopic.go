...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v12/pubsubtopic/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/pubsub_topic google_pubsub_topic}.
...
type jsiiProxy_PubsubTopic struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_PubsubTopic) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_PubsubTopic) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_PubsubTopic) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_PubsubTopic) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_PubsubTopic) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_PubsubTopic) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_PubsubTopic) KmsKeyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyName",
...
func (j *jsiiProxy_PubsubTopic) KmsKeyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kmsKeyNameInput",
...
func (j *jsiiProxy_PubsubTopic) Labels() *map[string]*string {
...
func (j *jsiiProxy_PubsubTopic) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_PubsubTopic) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_PubsubTopic) MessageRetentionDuration() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PubsubTopic) MessageRetentionDurationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PubsubTopic) MessageStoragePolicy() PubsubTopicMessageStoragePolicyOutputReference {
	var returns PubsubTopicMessageStoragePolicyOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PubsubTopic) MessageStoragePolicyInput() *PubsubTopicMessageStoragePolicy {
...
func (j *jsiiProxy_PubsubTopic) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_PubsubTopic) Node() constructs.Node {
...
func (j *jsiiProxy_PubsubTopic) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_PubsubTopic) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_PubsubTopic) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_PubsubTopic) SchemaSettings() PubsubTopicSchemaSettingsOutputReference {
	var returns PubsubTopicSchemaSettingsOutputReference
	_jsii_.Get(
		j,
		"schemaSettings",
		&returns,
...
func (j *jsiiProxy_PubsubTopic) SchemaSettingsInput() *PubsubTopicSchemaSettings {
	var returns *PubsubTopicSchemaSettings
	_jsii_.Get(
		j,
		"schemaSettingsInput",
		&returns,
...
func (j *jsiiProxy_PubsubTopic) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_PubsubTopic) Timeouts() PubsubTopicTimeoutsOutputReference {
	var returns PubsubTopicTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/5.11.0/docs/resources/pubsub_topic google_pubsub_topic} Resource.
func NewPubsubTopic(scope constructs.Construct, id *string, config *PubsubTopicConfig) PubsubTopic {
	_init_.Initialize()

	if err := validateNewPubsubTopicParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func PubsubTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validatePubsubTopic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PubsubTopic) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PubsubTopic) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PubsubTopic) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (p *jsiiProxy_PubsubTopic) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (p *jsiiProxy_PubsubTopic) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (p *jsiiProxy_PubsubTopic) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (p *jsiiProxy_PubsubTopic) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (p *jsiiProxy_PubsubTopic) GetStringAttribute(terraformAttribute *string) *string {
...
func (p *jsiiProxy_PubsubTopic) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (p *jsiiProxy_PubsubTopic) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PubsubTopic) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PubsubTopic) MoveFromId(id *string) {
...
func (p *jsiiProxy_PubsubTopic) MoveToId(id *string) {
...
func (p *jsiiProxy_PubsubTopic) OverrideLogicalId(newLogicalId *string) {
...
func (p *jsiiProxy_PubsubTopic) PutTimeouts(value *PubsubTopicTimeouts) {
...
func (p *jsiiProxy_PubsubTopic) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetKmsKeyName() {
	_jsii_.InvokeVoid(
		p,
		"resetKmsKeyName",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetLabels() {
	_jsii_.InvokeVoid(
		p,
		"resetLabels",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetMessageRetentionDuration() {
	_jsii_.InvokeVoid(
		p,
		"resetMessageRetentionDuration",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetMessageStoragePolicy() {
	_jsii_.InvokeVoid(
		p,
		"resetMessageStoragePolicy",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetProject() {
	_jsii_.InvokeVoid(
		p,
		"resetProject",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetSchemaSettings() {
	_jsii_.InvokeVoid(
		p,
		"resetSchemaSettings",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ResetTimeouts() {
	_jsii_.InvokeVoid(
		p,
		"resetTimeouts",
		nil, // no parameters
...
func (p *jsiiProxy_PubsubTopic) ToString() *string {
	var returns *string
