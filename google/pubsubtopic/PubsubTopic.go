...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/pubsubtopic/internal"
...
func (j *jsiiProxy_PubsubTopic) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PubsubTopic)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
