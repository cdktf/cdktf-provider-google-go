...
type PubsubTopicIngestionDataSourceSettingsAwsMsk struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.34.0/docs/resources/pubsub_topic#aws_role_arn PubsubTopic#aws_role_arn}
	AwsRoleArn *string `field:"required" json:"awsRoleArn" yaml:"awsRoleArn"`
	// ARN that uniquely identifies the MSK cluster.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.34.0/docs/resources/pubsub_topic#cluster_arn PubsubTopic#cluster_arn}
