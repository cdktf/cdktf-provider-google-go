...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.10.0/docs/resources/healthcare_hl7_v2_store_iam_binding google_healthcare_hl7_v2_store_iam_binding}.
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.10.0/docs/resources/healthcare_hl7_v2_store_iam_binding google_healthcare_hl7_v2_store_iam_binding} Resource.
...
func (j *jsiiProxy_HealthcareHl7V2StoreIamBinding)SetCount(val interface{}) {
...
// Experimental.
func HealthcareHl7V2StoreIamBinding_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func HealthcareHl7V2StoreIamBinding_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HealthcareHl7V2StoreIamBinding) ToHclTerraform() interface{} {
	var returns interface{}
