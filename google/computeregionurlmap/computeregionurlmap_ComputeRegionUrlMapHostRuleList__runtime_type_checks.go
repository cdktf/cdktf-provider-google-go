...
func (c *jsiiProxy_ComputeRegionUrlMapHostRuleList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_ComputeRegionUrlMapHostRuleList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*ComputeRegionUrlMapHostRule:
		val_ := val.([]*ComputeRegionUrlMapHostRule)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_ComputeRegionUrlMapHostRuleList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ComputeRegionUrlMapHostRuleList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
