...
func (c *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesRouteActionOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionUrlMapPathMatcherRouteRulesRouteActionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
