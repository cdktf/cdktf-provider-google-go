...
func (j *jsiiProxy_DataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList {
	_init_.Initialize()
...
func NewDataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList_Override(d DataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeReservationSpecificReservationInstancePropertiesLocalSsdsList) Resolve(_context cdktf.IResolveContext) interface{} {
