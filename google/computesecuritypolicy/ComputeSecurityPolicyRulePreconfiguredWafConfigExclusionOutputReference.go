...
func (c *jsiiProxy_ComputeSecurityPolicyRulePreconfiguredWafConfigExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyRulePreconfiguredWafConfigExclusionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
