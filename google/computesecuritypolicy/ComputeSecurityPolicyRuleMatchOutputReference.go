...
func (c *jsiiProxy_ComputeSecurityPolicyRuleMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyRuleMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
