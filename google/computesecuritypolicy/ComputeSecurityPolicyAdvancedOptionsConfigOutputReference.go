...
func (c *jsiiProxy_ComputeSecurityPolicyAdvancedOptionsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeSecurityPolicyAdvancedOptionsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
