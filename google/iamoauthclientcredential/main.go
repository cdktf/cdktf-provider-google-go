...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "oauthClientCredentialId", GoGetter: "OauthClientCredentialId"},
			_jsii_.MemberProperty{JsiiProperty: "oauthClientCredentialIdInput", GoGetter: "OauthClientCredentialIdInput"},
