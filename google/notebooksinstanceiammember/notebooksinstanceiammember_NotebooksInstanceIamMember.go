...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v4/notebooksinstanceiammember/internal"
...
// Experimental.
func NotebooksInstanceIamMember_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()
...
// Experimental.
func NotebooksInstanceIamMember_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()
