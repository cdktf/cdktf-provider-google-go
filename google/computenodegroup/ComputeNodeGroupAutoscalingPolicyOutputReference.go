...
func (c *jsiiProxy_ComputeNodeGroupAutoscalingPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeNodeGroupAutoscalingPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
