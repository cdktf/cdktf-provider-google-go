...
func (s *jsiiProxy_SecretManagerSecretTopicsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SecretManagerSecretTopicsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
