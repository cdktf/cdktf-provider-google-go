...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/secret_manager_secret google_secret_manager_secret}.
...
func (j *jsiiProxy_SecretManagerSecret) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/secret_manager_secret google_secret_manager_secret} Resource.
...
func (s *jsiiProxy_SecretManagerSecret) ResetDeletionProtection() {
	_jsii_.InvokeVoid(
		s,
		"resetDeletionProtection",
		nil, // no parameters
...
func (s *jsiiProxy_SecretManagerSecret) ResetTags() {
	_jsii_.InvokeVoid(
		s,
		"resetTags",
		nil, // no parameters
