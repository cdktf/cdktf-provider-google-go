...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) InternalValue() interface{} {
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList)SetWrapsSet(val *bool) {
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) ComputeFqn() *string {
	var returns *string
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) Get(index *float64) WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsOutputReference {
	if err := w.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsOutputReference
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (w *jsiiProxy_WorkbenchInstanceGceSetupNetworkInterfacesAccessConfigsList) ToString() *string {
	var returns *string
