...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dedicatedServingEndpoint", GoGetter: "DedicatedServingEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "dedicatedServingEndpointInput", GoGetter: "DedicatedServingEndpointInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "optimized", GoGetter: "Optimized"},
			_jsii_.MemberProperty{JsiiProperty: "optimizedInput", GoGetter: "OptimizedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putDedicatedServingEndpoint", GoMethod: "PutDedicatedServingEndpoint"},
			_jsii_.MemberMethod{JsiiMethod: "putOptimized", GoMethod: "PutOptimized"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOptimized", GoMethod: "ResetOptimized"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cpuUtilizationTarget", GoGetter: "CpuUtilizationTarget"},
			_jsii_.MemberProperty{JsiiProperty: "cpuUtilizationTargetInput", GoGetter: "CpuUtilizationTargetInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCpuUtilizationTarget", GoMethod: "ResetCpuUtilizationTarget"},
