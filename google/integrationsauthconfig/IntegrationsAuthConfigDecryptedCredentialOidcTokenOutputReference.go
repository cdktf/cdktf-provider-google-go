...
func (i *jsiiProxy_IntegrationsAuthConfigDecryptedCredentialOidcTokenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationsAuthConfigDecryptedCredentialOidcTokenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
