...
type jsiiProxy_HealthcareDatasetIamPolicy struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_HealthcareDatasetIamPolicy) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) DatasetId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetId",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) DatasetIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetIdInput",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) Node() constructs.Node {
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) PolicyData() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyData",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) PolicyDataInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyDataInput",
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_HealthcareDatasetIamPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewHealthcareDatasetIamPolicy(scope constructs.Construct, id *string, config *HealthcareDatasetIamPolicyConfig) HealthcareDatasetIamPolicy {
	...
	if err := validateNewHealthcareDatasetIamPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_HealthcareDatasetIamPolicy{}
...
func HealthcareDatasetIamPolicy_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.HealthcareDatasetIamPolicy",
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) ResetId() {
	_jsii_.InvokeVoid(
		h,
		"resetId",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		h,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareDatasetIamPolicy) ToString() *string {
	var returns *string
