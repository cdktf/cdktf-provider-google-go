...
func (g *jsiiProxy_GkeHubFeatureMembershipPolicycontrollerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GkeHubFeatureMembershipPolicycontrollerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
