...
func (j *jsiiProxy_GkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList {
	_init_.Initialize()
...
func NewGkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList_Override(g GkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GkeHubFeatureMembershipConfigmanagementConfigSyncDeploymentOverridesList) Resolve(_context cdktf.IResolveContext) interface{} {
