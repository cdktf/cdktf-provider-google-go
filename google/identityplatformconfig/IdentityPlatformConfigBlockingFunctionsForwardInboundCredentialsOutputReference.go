...
func (i *jsiiProxy_IdentityPlatformConfigBlockingFunctionsForwardInboundCredentialsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfigBlockingFunctionsForwardInboundCredentialsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
