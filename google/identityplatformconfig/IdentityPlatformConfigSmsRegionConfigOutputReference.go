...
func (i *jsiiProxy_IdentityPlatformConfigSmsRegionConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfigSmsRegionConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
