...
func (i *jsiiProxy_IdentityPlatformConfigSmsRegionConfigAllowByDefaultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IdentityPlatformConfigSmsRegionConfigAllowByDefaultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
