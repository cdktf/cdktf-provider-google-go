...
func (m *jsiiProxy_ModelArmorFloorsettingFilterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ModelArmorFloorsettingFilterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
