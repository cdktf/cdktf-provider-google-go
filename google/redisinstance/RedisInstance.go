...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/redisinstance/internal"
...
func (j *jsiiProxy_RedisInstance) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RedisInstance)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
