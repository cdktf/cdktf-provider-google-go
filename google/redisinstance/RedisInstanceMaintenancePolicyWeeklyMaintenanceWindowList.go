...
func (r *jsiiProxy_RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (r *jsiiProxy_RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowList) Resolve(context cdktf.IResolveContext) interface{} {
