...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableObjectRetentionInput", GoGetter: "EnableObjectRetentionInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetTerminalStorageClass", GoMethod: "ResetTerminalStorageClass"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terminalStorageClass", GoGetter: "TerminalStorageClass"},
			_jsii_.MemberProperty{JsiiProperty: "terminalStorageClassInput", GoGetter: "TerminalStorageClassInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSendAgeIfZero", GoMethod: "ResetSendAgeIfZero"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendDaysSinceCustomTimeIfZero", GoMethod: "ResetSendDaysSinceCustomTimeIfZero"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendDaysSinceNoncurrentTimeIfZero", GoMethod: "ResetSendDaysSinceNoncurrentTimeIfZero"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendNumNewerVersionsIfZero", GoMethod: "ResetSendNumNewerVersionsIfZero"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sendAgeIfZeroInput", GoGetter: "SendAgeIfZeroInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendDaysSinceCustomTimeIfZero", GoGetter: "SendDaysSinceCustomTimeIfZero"},
			_jsii_.MemberProperty{JsiiProperty: "sendDaysSinceCustomTimeIfZeroInput", GoGetter: "SendDaysSinceCustomTimeIfZeroInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendDaysSinceNoncurrentTimeIfZero", GoGetter: "SendDaysSinceNoncurrentTimeIfZero"},
			_jsii_.MemberProperty{JsiiProperty: "sendDaysSinceNoncurrentTimeIfZeroInput", GoGetter: "SendDaysSinceNoncurrentTimeIfZeroInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendNumNewerVersionsIfZero", GoGetter: "SendNumNewerVersionsIfZero"},
			_jsii_.MemberProperty{JsiiProperty: "sendNumNewerVersionsIfZeroInput", GoGetter: "SendNumNewerVersionsIfZeroInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
