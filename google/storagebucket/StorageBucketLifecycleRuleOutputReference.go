...
func (s *jsiiProxy_StorageBucketLifecycleRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageBucketLifecycleRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
