...
func (j *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList {
	_init_.Initialize()
...
func NewDataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList_Override(d DataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleGkeHubFeatureSpecClusterupgradeGkeUpgradeOverridesUpgradeList) Resolve(_context cdktf.IResolveContext) interface{} {
