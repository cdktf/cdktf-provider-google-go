...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/firestoredatabase/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/firestore_database google_firestore_database}.
...
func (j *jsiiProxy_FirestoreDatabase) DatabaseEdition() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseEdition",
...
func (j *jsiiProxy_FirestoreDatabase) DatabaseEditionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_FirestoreDatabase) Tags() *map[string]*string {
...
func (j *jsiiProxy_FirestoreDatabase) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.49.1/docs/resources/firestore_database google_firestore_database} Resource.
...
func (f *jsiiProxy_FirestoreDatabase) ResetDatabaseEdition() {
	_jsii_.InvokeVoid(
		f,
		"resetDatabaseEdition",
		nil, // no parameters
...
func (f *jsiiProxy_FirestoreDatabase) ResetTags() {
	_jsii_.InvokeVoid(
		f,
		"resetTags",
		nil, // no parameters
