...
func (n *jsiiProxy_NetworkSecurityServerTlsPolicyServerCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityServerTlsPolicyServerCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
