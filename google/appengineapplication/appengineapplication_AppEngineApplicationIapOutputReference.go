...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/appengineapplication/internal"
...
type AppEngineApplicationIapOutputReference interface {
	...
	SetInternalValue(val *AppEngineApplicationIap)
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) InternalValue() *AppEngineApplicationIap {
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) Oauth2ClientId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"oauth2ClientId",
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) Oauth2ClientIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"oauth2ClientIdInput",
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) Oauth2ClientSecret() *string {
	var returns *string
	_jsii_.Get(
		j,
		"oauth2ClientSecret",
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) Oauth2ClientSecretInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_AppEngineApplicationIapOutputReference) Oauth2ClientSecretSha256() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) ComputeFqn() *string {
	var returns *string
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) ResetEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_AppEngineApplicationIapOutputReference) ToString() *string {
	var returns *string
