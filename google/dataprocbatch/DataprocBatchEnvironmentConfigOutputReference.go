...
func (d *jsiiProxy_DataprocBatchEnvironmentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocBatchEnvironmentConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
