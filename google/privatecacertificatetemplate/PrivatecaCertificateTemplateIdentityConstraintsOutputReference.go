...
func (p *jsiiProxy_PrivatecaCertificateTemplateIdentityConstraintsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivatecaCertificateTemplateIdentityConstraintsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
