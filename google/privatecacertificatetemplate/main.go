...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "nullCa", GoGetter: "NullCa"},
			_jsii_.MemberProperty{JsiiProperty: "nullCaInput", GoGetter: "NullCaInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNullCa", GoMethod: "ResetNullCa"},
