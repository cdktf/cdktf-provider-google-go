...
func (d *jsiiProxy_DeveloperConnectConnectionGithubEnterpriseConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeveloperConnectConnectionGithubEnterpriseConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
