...
func (c *jsiiProxy_ComputeRegionBackendServiceHaPolicyLeaderOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionBackendServiceHaPolicyLeaderOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
