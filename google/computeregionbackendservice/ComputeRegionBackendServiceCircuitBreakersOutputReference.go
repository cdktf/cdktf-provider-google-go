...
func (c *jsiiProxy_ComputeRegionBackendServiceCircuitBreakersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionBackendServiceCircuitBreakersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
