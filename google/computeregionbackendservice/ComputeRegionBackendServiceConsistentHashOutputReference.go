...
func (c *jsiiProxy_ComputeRegionBackendServiceConsistentHashOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeRegionBackendServiceConsistentHashOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
