...
func (s *jsiiProxy_StorageControlProjectIntelligenceConfigTrialConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_StorageControlProjectIntelligenceConfigTrialConfigList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_StorageControlProjectIntelligenceConfigTrialConfigList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_StorageControlProjectIntelligenceConfigTrialConfigList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
