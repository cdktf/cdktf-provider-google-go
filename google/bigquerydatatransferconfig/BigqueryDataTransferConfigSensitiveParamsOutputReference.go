...
func (b *jsiiProxy_BigqueryDataTransferConfigSensitiveParamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryDataTransferConfigSensitiveParamsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
