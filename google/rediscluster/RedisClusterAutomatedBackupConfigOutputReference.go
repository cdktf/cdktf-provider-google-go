...
func (r *jsiiProxy_RedisClusterAutomatedBackupConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisClusterAutomatedBackupConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
