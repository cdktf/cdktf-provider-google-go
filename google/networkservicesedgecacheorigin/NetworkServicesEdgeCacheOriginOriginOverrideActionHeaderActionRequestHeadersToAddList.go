...
func (n *jsiiProxy_NetworkServicesEdgeCacheOriginOriginOverrideActionHeaderActionRequestHeadersToAddList) Resolve(context cdktf.IResolveContext) interface{} {
