...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/networkconnectivityserviceconnectionpolicy/internal"
...
func (j *jsiiProxy_NetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewNetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) NetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference {
	_init_.Initialize()
...
func NewNetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference_Override(n NetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_NetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (n *jsiiProxy_NetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkConnectivityServiceConnectionPolicyPscConnectionsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
