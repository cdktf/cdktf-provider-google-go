...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "producerInstanceLocation", GoGetter: "ProducerInstanceLocation"},
			_jsii_.MemberProperty{JsiiProperty: "producerInstanceLocationInput", GoGetter: "ProducerInstanceLocationInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedGoogleProducersResourceHierarchyLevel", GoMethod: "ResetAllowedGoogleProducersResourceHierarchyLevel"},
			_jsii_.MemberMethod{JsiiMethod: "resetLimit", GoMethod: "ResetLimit"},
			_jsii_.MemberMethod{JsiiMethod: "resetProducerInstanceLocation", GoMethod: "ResetProducerInstanceLocation"},
