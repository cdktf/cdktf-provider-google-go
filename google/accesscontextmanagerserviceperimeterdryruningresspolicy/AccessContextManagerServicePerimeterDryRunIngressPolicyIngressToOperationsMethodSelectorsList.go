...
func (a *jsiiProxy_AccessContextManagerServicePerimeterDryRunIngressPolicyIngressToOperationsMethodSelectorsList) Resolve(context cdktf.IResolveContext) interface{} {
