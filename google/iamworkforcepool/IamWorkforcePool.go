...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/iamworkforcepool/internal"
...
func (j *jsiiProxy_IamWorkforcePool) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IamWorkforcePool)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
