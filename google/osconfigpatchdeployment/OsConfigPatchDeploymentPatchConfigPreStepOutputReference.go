...
func (o *jsiiProxy_OsConfigPatchDeploymentPatchConfigPreStepOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OsConfigPatchDeploymentPatchConfigPreStepOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
