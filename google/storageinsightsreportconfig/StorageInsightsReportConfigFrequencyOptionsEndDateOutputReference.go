...
func (s *jsiiProxy_StorageInsightsReportConfigFrequencyOptionsEndDateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageInsightsReportConfigFrequencyOptionsEndDateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
