...
func (s *jsiiProxy_StorageInsightsReportConfigCsvOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageInsightsReportConfigCsvOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
