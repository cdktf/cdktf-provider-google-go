...
func (m *jsiiProxy_MonitoringUptimeCheckConfigContentMatchersJsonPathMatcherOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfigContentMatchersJsonPathMatcherOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
