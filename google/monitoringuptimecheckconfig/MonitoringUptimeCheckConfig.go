...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.38.0/docs/resources/monitoring_uptime_check_config google_monitoring_uptime_check_config} Resource.
...
func MonitoringUptimeCheckConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateMonitoringUptimeCheckConfig_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitoringUptimeCheckConfig) ResetLogCheckFailures() {
	_jsii_.InvokeVoid(
		m,
		"resetLogCheckFailures",
		nil, // no parameters
