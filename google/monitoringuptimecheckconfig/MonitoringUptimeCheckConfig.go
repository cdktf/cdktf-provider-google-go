...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v6/monitoringuptimecheckconfig/internal"
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MonitoringUptimeCheckConfig)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
