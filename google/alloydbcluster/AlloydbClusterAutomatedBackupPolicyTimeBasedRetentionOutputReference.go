...
func (a *jsiiProxy_AlloydbClusterAutomatedBackupPolicyTimeBasedRetentionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlloydbClusterAutomatedBackupPolicyTimeBasedRetentionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
