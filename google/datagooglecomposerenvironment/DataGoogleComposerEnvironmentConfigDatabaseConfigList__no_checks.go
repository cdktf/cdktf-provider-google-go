...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigDatabaseConfigList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigDatabaseConfigList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
