...
func (m *jsiiProxy_MonitoringNotificationChannelSensitiveLabelsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitoringNotificationChannelSensitiveLabelsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
