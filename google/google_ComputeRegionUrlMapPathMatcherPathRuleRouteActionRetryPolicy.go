...
type ComputeRegionUrlMapPathMatcherPathRuleRouteActionRetryPolicy struct {
	...
	PerTryTimeout *ComputeRegionUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout `field:"optional" json:"perTryTimeout" yaml:"perTryTimeout"`
