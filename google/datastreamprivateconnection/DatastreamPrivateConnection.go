...
func (j *jsiiProxy_DatastreamPrivateConnection) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DatastreamPrivateConnection) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DatastreamPrivateConnection) DisplayNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayNameInput",
...
func (j *jsiiProxy_DatastreamPrivateConnection) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DatastreamPrivateConnection) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DatastreamPrivateConnection) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DatastreamPrivateConnection) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DatastreamPrivateConnection) Labels() *map[string]*string {
...
func (j *jsiiProxy_DatastreamPrivateConnection) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_DatastreamPrivateConnection) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DatastreamPrivateConnection) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DatastreamPrivateConnection) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DatastreamPrivateConnection) Node() constructs.Node {
...
func (j *jsiiProxy_DatastreamPrivateConnection) PrivateConnectionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"privateConnectionId",
...
func (j *jsiiProxy_DatastreamPrivateConnection) PrivateConnectionIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatastreamPrivateConnection) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DatastreamPrivateConnection) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DatastreamPrivateConnection) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DatastreamPrivateConnection) Timeouts() DatastreamPrivateConnectionTimeoutsOutputReference {
	var returns DatastreamPrivateConnectionTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_DatastreamPrivateConnection) VpcPeeringConfig() DatastreamPrivateConnectionVpcPeeringConfigOutputReference {
	var returns DatastreamPrivateConnectionVpcPeeringConfigOutputReference
	_jsii_.Get(
		j,
		"vpcPeeringConfig",
		&returns,
...
func (j *jsiiProxy_DatastreamPrivateConnection) VpcPeeringConfigInput() *DatastreamPrivateConnectionVpcPeeringConfig {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.20.0/docs/resources/datastream_private_connection google_datastream_private_connection} Resource.
func NewDatastreamPrivateConnection(scope constructs.Construct, id *string, config *DatastreamPrivateConnectionConfig) DatastreamPrivateConnection {
	...
	if err := validateNewDatastreamPrivateConnectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DatastreamPrivateConnection_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.datastreamPrivateConnection.DatastreamPrivateConnection",
...
func (d *jsiiProxy_DatastreamPrivateConnection) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DatastreamPrivateConnection) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DatastreamPrivateConnection) MoveFromId(id *string) {
...
func (d *jsiiProxy_DatastreamPrivateConnection) MoveToId(id *string) {
...
func (d *jsiiProxy_DatastreamPrivateConnection) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DatastreamPrivateConnection) PutVpcPeeringConfig(value *DatastreamPrivateConnectionVpcPeeringConfig) {
...
func (d *jsiiProxy_DatastreamPrivateConnection) ResetCreateWithoutValidation() {
	_jsii_.InvokeVoid(
		d,
		"resetCreateWithoutValidation",
		nil, // no parameters
...
func (d *jsiiProxy_DatastreamPrivateConnection) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DatastreamPrivateConnection) ResetLabels() {
	_jsii_.InvokeVoid(
		d,
		"resetLabels",
		nil, // no parameters
...
func (d *jsiiProxy_DatastreamPrivateConnection) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DatastreamPrivateConnection) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DatastreamPrivateConnection) ToString() *string {
	var returns *string
