...
func (j *jsiiProxy_DatastreamPrivateConnectionErrorList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DatastreamPrivateConnectionErrorList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
