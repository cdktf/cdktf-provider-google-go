...
func (o *jsiiProxy_OsConfigV2PolicyOrchestratorForFolderOrchestrationStateCurrentIterationStateErrorList) Resolve(context cdktf.IResolveContext) interface{} {
