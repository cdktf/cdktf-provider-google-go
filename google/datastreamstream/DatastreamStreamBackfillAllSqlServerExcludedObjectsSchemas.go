...
type DatastreamStreamBackfillAllSqlServerExcludedObjectsSchemas struct {
	...
	// tables block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.39.0/docs/resources/datastream_stream#tables DatastreamStream#tables}
