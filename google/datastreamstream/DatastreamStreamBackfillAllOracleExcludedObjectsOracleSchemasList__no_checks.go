...
func (d *jsiiProxy_DatastreamStreamBackfillAllOracleExcludedObjectsOracleSchemasList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DatastreamStreamBackfillAllOracleExcludedObjectsOracleSchemasList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
