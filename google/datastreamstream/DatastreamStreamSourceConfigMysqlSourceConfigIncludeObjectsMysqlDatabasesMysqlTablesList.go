...
func (d *jsiiProxy_DatastreamStreamSourceConfigMysqlSourceConfigIncludeObjectsMysqlDatabasesMysqlTablesList) Resolve(context cdktf.IResolveContext) interface{} {
