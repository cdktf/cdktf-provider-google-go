...
func (g *jsiiProxy_GkeonpremVmwareNodePoolConfigVsphereConfigTagsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GkeonpremVmwareNodePoolConfigVsphereConfigTagsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (g *jsiiProxy_GkeonpremVmwareNodePoolConfigVsphereConfigTagsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_GkeonpremVmwareNodePoolConfigVsphereConfigTagsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
