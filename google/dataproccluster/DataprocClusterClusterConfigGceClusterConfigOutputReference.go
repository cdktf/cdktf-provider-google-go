...
func (d *jsiiProxy_DataprocClusterClusterConfigGceClusterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocClusterClusterConfigGceClusterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
