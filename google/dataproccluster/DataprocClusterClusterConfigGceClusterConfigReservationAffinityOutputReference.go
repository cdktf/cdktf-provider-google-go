...
func (d *jsiiProxy_DataprocClusterClusterConfigGceClusterConfigReservationAffinityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocClusterClusterConfigGceClusterConfigReservationAffinityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
