...
func (d *jsiiProxy_DataprocClusterVirtualClusterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocClusterVirtualClusterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
