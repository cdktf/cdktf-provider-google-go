...
func (d *jsiiProxy_DataprocClusterClusterConfigSoftwareConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataprocClusterClusterConfigSoftwareConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
