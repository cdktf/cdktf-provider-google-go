...
type DataplexEntryTypeConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/5.43.1/docs/resources/dataplex_entry_type#labels DataplexEntryType#labels}
