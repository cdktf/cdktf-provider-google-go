...
func (d *jsiiProxy_DataGoogleComputeBackendServiceCircuitBreakersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceCircuitBreakersList) Resolve(context cdktf.IResolveContext) interface{} {
