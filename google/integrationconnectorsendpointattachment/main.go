...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "endpointGlobalAccess", GoGetter: "EndpointGlobalAccess"},
			_jsii_.MemberProperty{JsiiProperty: "endpointGlobalAccessInput", GoGetter: "EndpointGlobalAccessInput"},
