...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bareMetalCluster", GoGetter: "BareMetalCluster"},
			_jsii_.MemberProperty{JsiiProperty: "bareMetalClusterInput", GoGetter: "BareMetalClusterInput"},
