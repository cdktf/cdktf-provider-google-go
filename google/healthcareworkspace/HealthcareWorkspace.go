...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/healthcareworkspace/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/healthcare_workspace google_healthcare_workspace}.
...
func (j *jsiiProxy_HealthcareWorkspace) Dataset() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dataset",
...
func (j *jsiiProxy_HealthcareWorkspace) DatasetInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datasetInput",
...
func (j *jsiiProxy_HealthcareWorkspace) Labels() *map[string]*string {
...
func (j *jsiiProxy_HealthcareWorkspace) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_HealthcareWorkspace) Settings() HealthcareWorkspaceSettingsOutputReference {
	var returns HealthcareWorkspaceSettingsOutputReference
	_jsii_.Get(
		j,
		"settings",
		&returns,
...
func (j *jsiiProxy_HealthcareWorkspace) SettingsInput() *HealthcareWorkspaceSettings {
	var returns *HealthcareWorkspaceSettings
	_jsii_.Get(
		j,
		"settingsInput",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.47.0/docs/resources/healthcare_workspace google_healthcare_workspace} Resource.
...
func (j *jsiiProxy_HealthcareWorkspace)SetDataset(val *string) {
...
func (j *jsiiProxy_HealthcareWorkspace)SetLabels(val *map[string]*string) {
...
func (h *jsiiProxy_HealthcareWorkspace) AddMoveTarget(moveTarget *string) {
...
func (h *jsiiProxy_HealthcareWorkspace) HasResourceMove() interface{} {
	var returns interface{}
...
func (h *jsiiProxy_HealthcareWorkspace) MoveFromId(id *string) {
...
func (h *jsiiProxy_HealthcareWorkspace) MoveTo(moveTarget *string, index interface{}) {
...
func (h *jsiiProxy_HealthcareWorkspace) MoveToId(id *string) {
...
func (h *jsiiProxy_HealthcareWorkspace) PutSettings(value *HealthcareWorkspaceSettings) {
	if err := h.validatePutSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		h,
...
func (h *jsiiProxy_HealthcareWorkspace) ResetLabels() {
	_jsii_.InvokeVoid(
		h,
		"resetLabels",
		nil, // no parameters
...
func (h *jsiiProxy_HealthcareWorkspace) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HealthcareWorkspace) ToHclTerraform() interface{} {
	var returns interface{}
