...
type ArtifactRegistryRepositoryIamBindingConfig struct {
	// Experimental.
	...
	Condition *ArtifactRegistryRepositoryIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
