...
func NewDataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList {
	...
	_jsii_.Create(
		"@cdktf/provider-google.dataGoogleDataplexDataQualityRules.DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList",
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesTableConditionExpectationList) Resolve(context cdktf.IResolveContext) interface{} {
