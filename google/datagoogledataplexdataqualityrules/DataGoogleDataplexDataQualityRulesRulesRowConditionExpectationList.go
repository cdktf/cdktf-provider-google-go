...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-google.dataGoogleDataplexDataQualityRules.DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList",
...
func NewDataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList_Override(d DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesRowConditionExpectationList) Resolve(_context cdktf.IResolveContext) interface{} {
