...
func (s *jsiiProxy_SecureSourceManagerRepositoryInitialConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecureSourceManagerRepositoryInitialConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
