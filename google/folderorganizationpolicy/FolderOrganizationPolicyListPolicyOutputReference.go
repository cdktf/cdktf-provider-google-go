...
func (f *jsiiProxy_FolderOrganizationPolicyListPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FolderOrganizationPolicyListPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
