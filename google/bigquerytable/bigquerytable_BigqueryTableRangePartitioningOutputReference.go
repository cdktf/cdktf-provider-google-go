...
import (
	...
	"github.com/hashicorp/cdktf-provider-google-go/google/v3/bigquerytable/internal"
...
type BigqueryTableRangePartitioningOutputReference interface {
	...
	// Experimental.
	Fqn() *string
	InternalValue() *BigqueryTableRangePartitioning
	SetInternalValue(val *BigqueryTableRangePartitioning)
	Range() BigqueryTableRangePartitioningRangeOutputReference
	RangeInput() *BigqueryTableRangePartitioningRange
	// Experimental.
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) Field() *string {
	var returns *string
	_jsii_.Get(
		j,
		"field",
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) FieldInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fieldInput",
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) InternalValue() *BigqueryTableRangePartitioning {
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) Range() BigqueryTableRangePartitioningRangeOutputReference {
	var returns BigqueryTableRangePartitioningRangeOutputReference
	_jsii_.Get(
		j,
		"range",
		&returns,
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) RangeInput() *BigqueryTableRangePartitioningRange {
	var returns *BigqueryTableRangePartitioningRange
	_jsii_.Get(
		j,
		"rangeInput",
		&returns,
...
func (j *jsiiProxy_BigqueryTableRangePartitioningOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetStringAttribute(terraformAttribute *string) *string {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) PutRange(value *BigqueryTableRangePartitioningRange) {
	if err := b.validatePutRangeParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BigqueryTableRangePartitioningOutputReference) ToString() *string {
	var returns *string
