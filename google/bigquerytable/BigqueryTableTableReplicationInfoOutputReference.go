...
func (b *jsiiProxy_BigqueryTableTableReplicationInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryTableTableReplicationInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
