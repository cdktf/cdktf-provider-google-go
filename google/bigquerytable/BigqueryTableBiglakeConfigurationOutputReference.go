...
func (b *jsiiProxy_BigqueryTableBiglakeConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryTableBiglakeConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
