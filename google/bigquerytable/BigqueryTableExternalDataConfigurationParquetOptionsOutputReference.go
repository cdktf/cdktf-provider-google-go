...
func (b *jsiiProxy_BigqueryTableExternalDataConfigurationParquetOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BigqueryTableExternalDataConfigurationParquetOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
