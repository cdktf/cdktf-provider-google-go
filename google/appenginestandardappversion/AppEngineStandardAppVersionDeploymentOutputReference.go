...
func (a *jsiiProxy_AppEngineStandardAppVersionDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineStandardAppVersionDeploymentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
