...
func (a *jsiiProxy_AppEngineStandardAppVersionHandlersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppEngineStandardAppVersionHandlersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
