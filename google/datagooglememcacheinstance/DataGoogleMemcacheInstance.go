...
type DataGoogleMemcacheInstance interface {
	...
	MemcacheNodes() DataGoogleMemcacheInstanceMemcacheNodesList
	MemcacheParameters() DataGoogleMemcacheInstanceMemcacheParametersList
	...
	NodeConfig() DataGoogleMemcacheInstanceNodeConfigList
	NodeCount() *float64
	Project() *string
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) DiscoveryEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
		"discoveryEndpoint",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) DisplayName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"displayName",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) MaintenancePolicy() DataGoogleMemcacheInstanceMaintenancePolicyList {
	var returns DataGoogleMemcacheInstanceMaintenancePolicyList
	_jsii_.Get(
		j,
		"maintenancePolicy",
		&returns,
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) MaintenanceSchedule() DataGoogleMemcacheInstanceMaintenanceScheduleList {
	var returns DataGoogleMemcacheInstanceMaintenanceScheduleList
	_jsii_.Get(
		j,
		"maintenanceSchedule",
		&returns,
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) MemcacheFullVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memcacheFullVersion",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) MemcacheNodes() DataGoogleMemcacheInstanceMemcacheNodesList {
	var returns DataGoogleMemcacheInstanceMemcacheNodesList
	_jsii_.Get(
		j,
		"memcacheNodes",
		&returns,
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) MemcacheParameters() DataGoogleMemcacheInstanceMemcacheParametersList {
	var returns DataGoogleMemcacheInstanceMemcacheParametersList
	_jsii_.Get(
		j,
		"memcacheParameters",
		&returns,
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) MemcacheVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"memcacheVersion",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) NodeConfig() DataGoogleMemcacheInstanceNodeConfigList {
	var returns DataGoogleMemcacheInstanceNodeConfigList
	_jsii_.Get(
		j,
		"nodeConfig",
		&returns,
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) NodeCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"nodeCount",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) ReservedIpRangeId() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"reservedIpRangeId",
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleMemcacheInstance) Zones() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"zones",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.36.0/docs/data-sources/memcache_instance google_memcache_instance} Data Source.
func NewDataGoogleMemcacheInstance(scope constructs.Construct, id *string, config *DataGoogleMemcacheInstanceConfig) DataGoogleMemcacheInstance {
	...
	if err := validateNewDataGoogleMemcacheInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataGoogleMemcacheInstance_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.dataGoogleMemcacheInstance.DataGoogleMemcacheInstance",
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) ResetRegion() {
	_jsii_.InvokeVoid(
		d,
		"resetRegion",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleMemcacheInstance) ToString() *string {
	var returns *string
