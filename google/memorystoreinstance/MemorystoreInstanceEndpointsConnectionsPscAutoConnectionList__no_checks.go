...
func (m *jsiiProxy_MemorystoreInstanceEndpointsConnectionsPscAutoConnectionList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_MemorystoreInstanceEndpointsConnectionsPscAutoConnectionList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_MemorystoreInstanceEndpointsConnectionsPscAutoConnectionList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
