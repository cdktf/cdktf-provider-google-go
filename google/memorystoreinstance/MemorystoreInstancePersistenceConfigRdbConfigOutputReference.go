...
func (m *jsiiProxy_MemorystoreInstancePersistenceConfigRdbConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MemorystoreInstancePersistenceConfigRdbConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
