...
func (m *jsiiProxy_MemorystoreInstanceStateInfoUpdateInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MemorystoreInstanceStateInfoUpdateInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
