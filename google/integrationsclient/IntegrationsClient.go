...
type IntegrationsClient interface {
	...
	PutCloudKmsConfig(value *IntegrationsClientCloudKmsConfig)
...
type jsiiProxy_IntegrationsClient struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_IntegrationsClient) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IntegrationsClient) CloudKmsConfig() IntegrationsClientCloudKmsConfigOutputReference {
	var returns IntegrationsClientCloudKmsConfigOutputReference
	_jsii_.Get(
		j,
		"cloudKmsConfig",
		&returns,
...
func (j *jsiiProxy_IntegrationsClient) CloudKmsConfigInput() *IntegrationsClientCloudKmsConfig {
...
func (j *jsiiProxy_IntegrationsClient) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_IntegrationsClient) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IntegrationsClient) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_IntegrationsClient) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_IntegrationsClient) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_IntegrationsClient) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_IntegrationsClient) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IntegrationsClient) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_IntegrationsClient) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_IntegrationsClient) Node() constructs.Node {
...
func (j *jsiiProxy_IntegrationsClient) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_IntegrationsClient) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_IntegrationsClient) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IntegrationsClient) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_IntegrationsClient) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_IntegrationsClient) Timeouts() IntegrationsClientTimeoutsOutputReference {
	var returns IntegrationsClientTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/6.24.0/docs/resources/integrations_client google_integrations_client} Resource.
func NewIntegrationsClient(scope constructs.Construct, id *string, config *IntegrationsClientConfig) IntegrationsClient {
	_init_.Initialize()

	if err := validateNewIntegrationsClientParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IntegrationsClient_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIntegrationsClient_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IntegrationsClient_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.integrationsClient.IntegrationsClient",
...
func (i *jsiiProxy_IntegrationsClient) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IntegrationsClient) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationsClient) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (i *jsiiProxy_IntegrationsClient) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (i *jsiiProxy_IntegrationsClient) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (i *jsiiProxy_IntegrationsClient) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (i *jsiiProxy_IntegrationsClient) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (i *jsiiProxy_IntegrationsClient) GetStringAttribute(terraformAttribute *string) *string {
...
func (i *jsiiProxy_IntegrationsClient) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (i *jsiiProxy_IntegrationsClient) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IntegrationsClient) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IntegrationsClient) MoveFromId(id *string) {
...
func (i *jsiiProxy_IntegrationsClient) MoveToId(id *string) {
...
func (i *jsiiProxy_IntegrationsClient) OverrideLogicalId(newLogicalId *string) {
...
func (i *jsiiProxy_IntegrationsClient) PutCloudKmsConfig(value *IntegrationsClientCloudKmsConfig) {
	if err := i.validatePutCloudKmsConfigParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IntegrationsClient) PutTimeouts(value *IntegrationsClientTimeouts) {
...
func (i *jsiiProxy_IntegrationsClient) ResetCloudKmsConfig() {
	_jsii_.InvokeVoid(
		i,
		"resetCloudKmsConfig",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationsClient) ResetCreateSampleIntegrations() {
	_jsii_.InvokeVoid(
		i,
		"resetCreateSampleIntegrations",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationsClient) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		i,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationsClient) ResetProject() {
	_jsii_.InvokeVoid(
		i,
		"resetProject",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationsClient) ResetTimeouts() {
	_jsii_.InvokeVoid(
		i,
		"resetTimeouts",
		nil, // no parameters
...
func (i *jsiiProxy_IntegrationsClient) ToString() *string {
	var returns *string
