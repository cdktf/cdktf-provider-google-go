...
func (c *jsiiProxy_ClouddeployAutomationRulesAdvanceRolloutRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddeployAutomationRulesAdvanceRolloutRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
