...
func (c *jsiiProxy_ClouddeployAutomationRulesTimedPromoteReleaseRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClouddeployAutomationRulesTimedPromoteReleaseRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
