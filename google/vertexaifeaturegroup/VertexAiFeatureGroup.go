...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v14/vertexaifeaturegroup/internal"
...
func (j *jsiiProxy_VertexAiFeatureGroup) BigQuery() VertexAiFeatureGroupBigQueryOutputReference {
	var returns VertexAiFeatureGroupBigQueryOutputReference
	_jsii_.Get(
		j,
		"bigQuery",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureGroup) BigQueryInput() *VertexAiFeatureGroupBigQuery {
	var returns *VertexAiFeatureGroupBigQuery
	_jsii_.Get(
		j,
		"bigQueryInput",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureGroup) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_VertexAiFeatureGroup) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_VertexAiFeatureGroup) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Etag() *string {
	var returns *string
	_jsii_.Get(
		j,
		"etag",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_VertexAiFeatureGroup) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_VertexAiFeatureGroup) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Labels() *map[string]*string {
...
func (j *jsiiProxy_VertexAiFeatureGroup) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_VertexAiFeatureGroup) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Node() constructs.Node {
...
func (j *jsiiProxy_VertexAiFeatureGroup) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_VertexAiFeatureGroup) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_VertexAiFeatureGroup) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_VertexAiFeatureGroup) RegionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"regionInput",
...
func (j *jsiiProxy_VertexAiFeatureGroup) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_VertexAiFeatureGroup) Timeouts() VertexAiFeatureGroupTimeoutsOutputReference {
	var returns VertexAiFeatureGroupTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_VertexAiFeatureGroup) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func NewVertexAiFeatureGroup(scope constructs.Construct, id *string, config *VertexAiFeatureGroupConfig) VertexAiFeatureGroup {
	...
	if err := validateNewVertexAiFeatureGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func VertexAiFeatureGroup_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-google.vertexAiFeatureGroup.VertexAiFeatureGroup",
...
func (v *jsiiProxy_VertexAiFeatureGroup) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetStringAttribute(terraformAttribute *string) *string {
...
func (v *jsiiProxy_VertexAiFeatureGroup) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (v *jsiiProxy_VertexAiFeatureGroup) MoveFromId(id *string) {
...
func (v *jsiiProxy_VertexAiFeatureGroup) MoveToId(id *string) {
...
func (v *jsiiProxy_VertexAiFeatureGroup) OverrideLogicalId(newLogicalId *string) {
...
func (v *jsiiProxy_VertexAiFeatureGroup) PutBigQuery(value *VertexAiFeatureGroupBigQuery) {
	if err := v.validatePutBigQueryParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		v,
...
func (v *jsiiProxy_VertexAiFeatureGroup) PutTimeouts(value *VertexAiFeatureGroupTimeouts) {
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetBigQuery() {
	_jsii_.InvokeVoid(
		v,
		"resetBigQuery",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetDescription() {
	_jsii_.InvokeVoid(
		v,
		"resetDescription",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetId() {
	_jsii_.InvokeVoid(
		v,
		"resetId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetLabels() {
	_jsii_.InvokeVoid(
		v,
		"resetLabels",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetName() {
	_jsii_.InvokeVoid(
		v,
		"resetName",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		v,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetProject() {
	_jsii_.InvokeVoid(
		v,
		"resetProject",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetRegion() {
	_jsii_.InvokeVoid(
		v,
		"resetRegion",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ResetTimeouts() {
	_jsii_.InvokeVoid(
		v,
		"resetTimeouts",
		nil, // no parameters
...
func (v *jsiiProxy_VertexAiFeatureGroup) ToString() *string {
	var returns *string
