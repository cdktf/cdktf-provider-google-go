...
import (
	...
	"github.com/cdktf/cdktf-provider-google-go/google/v16/projectaccessapprovalsettings/internal"
...
func (p *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProjectAccessApprovalSettingsEnrolledServicesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
