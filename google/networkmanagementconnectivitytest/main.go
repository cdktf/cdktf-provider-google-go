...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bypassFirewallChecksInput", GoGetter: "BypassFirewallChecksInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRoundTrip", GoMethod: "ResetRoundTrip"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "roundTrip", GoGetter: "RoundTrip"},
			_jsii_.MemberProperty{JsiiProperty: "roundTripInput", GoGetter: "RoundTripInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "gkeMasterCluster", GoGetter: "GkeMasterCluster"},
			_jsii_.MemberProperty{JsiiProperty: "gkeMasterClusterInput", GoGetter: "GkeMasterClusterInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "redisCluster", GoGetter: "RedisCluster"},
			_jsii_.MemberProperty{JsiiProperty: "redisClusterInput", GoGetter: "RedisClusterInput"},
			_jsii_.MemberProperty{JsiiProperty: "redisInstance", GoGetter: "RedisInstance"},
			_jsii_.MemberProperty{JsiiProperty: "redisInstanceInput", GoGetter: "RedisInstanceInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudSqlInstance", GoMethod: "ResetCloudSqlInstance"},
			_jsii_.MemberMethod{JsiiMethod: "resetForwardingRule", GoMethod: "ResetForwardingRule"},
			_jsii_.MemberMethod{JsiiMethod: "resetFqdn", GoMethod: "ResetFqdn"},
			_jsii_.MemberMethod{JsiiMethod: "resetGkeMasterCluster", GoMethod: "ResetGkeMasterCluster"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRedisCluster", GoMethod: "ResetRedisCluster"},
			_jsii_.MemberMethod{JsiiMethod: "resetRedisInstance", GoMethod: "ResetRedisInstance"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cloudRunRevision", GoGetter: "CloudRunRevision"},
			_jsii_.MemberProperty{JsiiProperty: "cloudRunRevisionInput", GoGetter: "CloudRunRevisionInput"},
			_jsii_.MemberProperty{JsiiProperty: "cloudSqlInstance", GoGetter: "CloudSqlInstance"},
			_jsii_.MemberProperty{JsiiProperty: "cloudSqlInstanceInput", GoGetter: "CloudSqlInstanceInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			...
			_jsii_.MemberProperty{JsiiProperty: "projectId", GoGetter: "ProjectId"},
			_jsii_.MemberProperty{JsiiProperty: "projectIdInput", GoGetter: "ProjectIdInput"},
			_jsii_.MemberMethod{JsiiMethod: "putAppEngineVersion", GoMethod: "PutAppEngineVersion"},
			_jsii_.MemberMethod{JsiiMethod: "putCloudFunction", GoMethod: "PutCloudFunction"},
			_jsii_.MemberMethod{JsiiMethod: "putCloudRunRevision", GoMethod: "PutCloudRunRevision"},
			_jsii_.MemberMethod{JsiiMethod: "resetAppEngineVersion", GoMethod: "ResetAppEngineVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudFunction", GoMethod: "ResetCloudFunction"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudRunRevision", GoMethod: "ResetCloudRunRevision"},
			_jsii_.MemberMethod{JsiiMethod: "resetCloudSqlInstance", GoMethod: "ResetCloudSqlInstance"},
			_jsii_.MemberMethod{JsiiMethod: "resetGkeMasterCluster", GoMethod: "ResetGkeMasterCluster"},
			_jsii_.MemberMethod{JsiiMethod: "resetInstance", GoMethod: "ResetInstance"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpAddress", GoMethod: "ResetIpAddress"},
